...
**spec** | [**object**](.md) | Specification of the desired state for the Tigera API server. | [optional] 
**status** | [**IoTigeraOperatorV1APIServerStatus**](IoTigeraOperatorV1APIServerStatus.md) |  | [optional] 
