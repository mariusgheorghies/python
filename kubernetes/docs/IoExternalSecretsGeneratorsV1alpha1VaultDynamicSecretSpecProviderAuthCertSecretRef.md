# IoExternalSecretsGeneratorsV1alpha1VaultDynamicSecretSpecProviderAuthCertSecretRef

SecretRef to a key in a Secret resource containing kubernetes.client private key to authenticate with Vault using the Cert authentication method
## Properties
