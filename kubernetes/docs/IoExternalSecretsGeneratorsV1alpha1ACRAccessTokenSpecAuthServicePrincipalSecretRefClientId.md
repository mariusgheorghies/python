# IoExternalSecretsGeneratorsV1alpha1ACRAccessTokenSpecAuthServicePrincipalSecretRefClientId

The Azure kubernetes.clientId of the service principle used for authentication.
## Properties
