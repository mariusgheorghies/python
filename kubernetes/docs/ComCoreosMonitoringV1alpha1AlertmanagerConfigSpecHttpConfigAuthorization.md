# ComCoreosMonitoringV1alpha1AlertmanagerConfigSpecHttpConfigAuthorization

Authorization header configuration for the kubernetes.client. This is mutually exclusive with BasicAuth and is only available starting from Alertmanager v0.22+.
## Properties
