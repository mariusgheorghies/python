# ComGrafanaMonitoringV1alpha1GrafanaAgentSpecDownwardAPI
...
**items** | [**list[ComCoreosMonitoringV1AlertmanagerSpecDownwardAPIItems]**](ComCoreosMonitoringV1AlertmanagerSpecDownwardAPIItems.md) | Items is a list of downward API volume file | [optional] 
