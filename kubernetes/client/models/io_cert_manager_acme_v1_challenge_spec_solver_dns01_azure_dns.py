...
class IoCertManagerAcmeV1ChallengeSpecSolverDns01AzureDNS(object):
    ...
    def __init__(self, client_id=None, client_secret_secret_ref=None, environment=None, hosted_zone_name=None, resource_group_name=None, subscription_id=None, tenant_id=None, local_vars_configuration=None):  # noqa: E501
