...
class IoCertManagerV1beta1CertificateSpec(object):
    ...
    openapi_types = {
        ...
        'private_key': 'IoCertManagerV1beta1CertificateSpecPrivateKey',
        'renew_before': 'str',
    ...
    def __init__(self, common_name=None, dns_names=None, duration=None, email_sa_ns=None, encode_usages_in_request=None, ip_addresses=None, is_ca=None, issuer_ref=None, keystores=None, private_key=None, renew_before=None, revision_history_limit=None, secret_name=None, secret_template=None, subject=None, uri_sa_ns=None, usages=None, local_vars_configuration=None):  # noqa: E501
        """IoCertManagerV1beta1CertificateSpec - a model defined in OpenAPI"""  # noqa: E501
    ...
    def common_name(self):
        """Gets the common_name of this IoCertManagerV1beta1CertificateSpec.  # noqa: E501
        ...
        :return: The common_name of this IoCertManagerV1beta1CertificateSpec.  # noqa: E501
        :rtype: str
        """
    ...
    def common_name(self, common_name):
        """Sets the common_name of this IoCertManagerV1beta1CertificateSpec.

        CommonName is a common name to be used on the Certificate. The CommonName should have a length of 64 characters or fewer to avoid generating invalid CSRs. This value is ignored by TLS clients when any subject alt name is set. This is x509 behaviour: https://tools.ietf.org/html/rfc6125#section-6.4.4  # noqa: E501

        :param common_name: The common_name of this IoCertManagerV1beta1CertificateSpec.  # noqa: E501
        :type: str
        """
    ...
    @property
    def dns_names(self):
        """Gets the dns_names of this IoCertManagerV1beta1CertificateSpec.  # noqa: E501

        DNSNames is a list of DNS subjectAltNames to be set on the Certificate.  # noqa: E501

        :return: The dns_names of this IoCertManagerV1beta1CertificateSpec.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def dns_names(self, dns_names):
        """Sets the dns_names of this IoCertManagerV1beta1CertificateSpec.

        DNSNames is a list of DNS subjectAltNames to be set on the Certificate.  # noqa: E501

        :param dns_names: The dns_names of this IoCertManagerV1beta1CertificateSpec.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def duration(self):
        """Gets the duration of this IoCertManagerV1beta1CertificateSpec.  # noqa: E501
        ...
        :return: The duration of this IoCertManagerV1beta1CertificateSpec.  # noqa: E501
        :rtype: str
        """
    ...
    def duration(self, duration):
        """Sets the duration of this IoCertManagerV1beta1CertificateSpec.

        The requested 'duration' (i.e. lifetime) of the Certificate. This option may be ignored/overridden by some issuer types. If unset this defaults to 90 days. Certificate will be renewed either 2/3 through its duration or `renewBefore` period before its expiry, whichever is later. Minimum accepted duration is 1 hour. Value must be in units accepted by Go time.ParseDuration https://golang.org/pkg/time/#ParseDuration  # noqa: E501

        :param duration: The duration of this IoCertManagerV1beta1CertificateSpec.  # noqa: E501
        :type: str
        """
    ...
    def email_sa_ns(self):
        """Gets the email_sa_ns of this IoCertManagerV1beta1CertificateSpec.  # noqa: E501

        EmailSANs is a list of email subjectAltNames to be set on the Certificate.  # noqa: E501

        :return: The email_sa_ns of this IoCertManagerV1beta1CertificateSpec.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def email_sa_ns(self, email_sa_ns):
        """Sets the email_sa_ns of this IoCertManagerV1beta1CertificateSpec.

        EmailSANs is a list of email subjectAltNames to be set on the Certificate.  # noqa: E501

        :param email_sa_ns: The email_sa_ns of this IoCertManagerV1beta1CertificateSpec.  # noqa: E501
        :type: list[str]
        """
    ...
    def encode_usages_in_request(self):
        """Gets the encode_usages_in_request of this IoCertManagerV1beta1CertificateSpec.  # noqa: E501

        EncodeUsagesInRequest controls whether key usages should be present in the CertificateRequest  # noqa: E501

        :return: The encode_usages_in_request of this IoCertManagerV1beta1CertificateSpec.  # noqa: E501
        :rtype: bool
        """
    ...
    def encode_usages_in_request(self, encode_usages_in_request):
        """Sets the encode_usages_in_request of this IoCertManagerV1beta1CertificateSpec.

        EncodeUsagesInRequest controls whether key usages should be present in the CertificateRequest  # noqa: E501

        :param encode_usages_in_request: The encode_usages_in_request of this IoCertManagerV1beta1CertificateSpec.  # noqa: E501
        :type: bool
        """
    ...
    def ip_addresses(self):
        """Gets the ip_addresses of this IoCertManagerV1beta1CertificateSpec.  # noqa: E501

        IPAddresses is a list of IP address subjectAltNames to be set on the Certificate.  # noqa: E501

        :return: The ip_addresses of this IoCertManagerV1beta1CertificateSpec.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def ip_addresses(self, ip_addresses):
        """Sets the ip_addresses of this IoCertManagerV1beta1CertificateSpec.

        IPAddresses is a list of IP address subjectAltNames to be set on the Certificate.  # noqa: E501

        :param ip_addresses: The ip_addresses of this IoCertManagerV1beta1CertificateSpec.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def is_ca(self):
        """Gets the is_ca of this IoCertManagerV1beta1CertificateSpec.  # noqa: E501
        ...
        :return: The is_ca of this IoCertManagerV1beta1CertificateSpec.  # noqa: E501
        :rtype: bool
        """
        return self._is_ca
    ...
    def is_ca(self, is_ca):
        """Sets the is_ca of this IoCertManagerV1beta1CertificateSpec.

        IsCA will mark this Certificate as valid for certificate signing. This will automatically add the `cert sign` usage to the list of `usages`.  # noqa: E501

        :param is_ca: The is_ca of this IoCertManagerV1beta1CertificateSpec.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def issuer_ref(self):
        """Gets the issuer_ref of this IoCertManagerV1beta1CertificateSpec.  # noqa: E501


        :return: The issuer_ref of this IoCertManagerV1beta1CertificateSpec.  # noqa: E501
    ...
    def issuer_ref(self, issuer_ref):
        """Sets the issuer_ref of this IoCertManagerV1beta1CertificateSpec.


        :param issuer_ref: The issuer_ref of this IoCertManagerV1beta1CertificateSpec.  # noqa: E501
    ...
    @property
    def keystores(self):
        """Gets the keystores of this IoCertManagerV1beta1CertificateSpec.  # noqa: E501


        :return: The keystores of this IoCertManagerV1beta1CertificateSpec.  # noqa: E501
    ...
    def keystores(self, keystores):
        """Sets the keystores of this IoCertManagerV1beta1CertificateSpec.


        :param keystores: The keystores of this IoCertManagerV1beta1CertificateSpec.  # noqa: E501
    ...
    def private_key(self):
        """Gets the private_key of this IoCertManagerV1beta1CertificateSpec.  # noqa: E501


        :return: The private_key of this IoCertManagerV1beta1CertificateSpec.  # noqa: E501
        :rtype: IoCertManagerV1beta1CertificateSpecPrivateKey
        """
        return self._private_key

    @private_key.setter
    def private_key(self, private_key):
        """Sets the private_key of this IoCertManagerV1beta1CertificateSpec.


        :param private_key: The private_key of this IoCertManagerV1beta1CertificateSpec.  # noqa: E501
        :type: IoCertManagerV1beta1CertificateSpecPrivateKey
        """
    ...
    def renew_before(self):
        """Gets the renew_before of this IoCertManagerV1beta1CertificateSpec.  # noqa: E501
        ...
        :return: The renew_before of this IoCertManagerV1beta1CertificateSpec.  # noqa: E501
        :rtype: str
        """
    ...
    def renew_before(self, renew_before):
        """Sets the renew_before of this IoCertManagerV1beta1CertificateSpec.

        How long before the currently issued certificate's expiry cert-manager should renew the certificate. The default is 2/3 of the issued certificate's duration. Minimum accepted value is 5 minutes. Value must be in units accepted by Go time.ParseDuration https://golang.org/pkg/time/#ParseDuration  # noqa: E501

        :param renew_before: The renew_before of this IoCertManagerV1beta1CertificateSpec.  # noqa: E501
        :type: str
        """
    ...
    def revision_history_limit(self):
        """Gets the revision_history_limit of this IoCertManagerV1beta1CertificateSpec.  # noqa: E501
        ...
        :return: The revision_history_limit of this IoCertManagerV1beta1CertificateSpec.  # noqa: E501
        :rtype: int
        """
    ...
    def revision_history_limit(self, revision_history_limit):
        """Sets the revision_history_limit of this IoCertManagerV1beta1CertificateSpec.

        revisionHistoryLimit is the maximum number of CertificateRequest revisions that are maintained in the Certificate's history. Each revision represents a single `CertificateRequest` created by this Certificate, either when it was created, renewed, or Spec was changed. Revisions will be removed by oldest first if the number of revisions exceeds this number. If set, revisionHistoryLimit must be a value of `1` or greater. If unset (`nil`), revisions will not be garbage collected. Default value is `nil`.  # noqa: E501

        :param revision_history_limit: The revision_history_limit of this IoCertManagerV1beta1CertificateSpec.  # noqa: E501
        :type: int
        """
    ...
    def secret_name(self):
        """Gets the secret_name of this IoCertManagerV1beta1CertificateSpec.  # noqa: E501
        ...
        :return: The secret_name of this IoCertManagerV1beta1CertificateSpec.  # noqa: E501
        :rtype: str
        """
    ...
    def secret_name(self, secret_name):
        """Sets the secret_name of this IoCertManagerV1beta1CertificateSpec.

        SecretName is the name of the secret resource that will be automatically created and managed by this Certificate resource. It will be populated with a private key and certificate, signed by the denoted issuer.  # noqa: E501

        :param secret_name: The secret_name of this IoCertManagerV1beta1CertificateSpec.  # noqa: E501
        :type: str
        """
    ...
    def secret_template(self):
        """Gets the secret_template of this IoCertManagerV1beta1CertificateSpec.  # noqa: E501


        :return: The secret_template of this IoCertManagerV1beta1CertificateSpec.  # noqa: E501
    ...
    def secret_template(self, secret_template):
        """Sets the secret_template of this IoCertManagerV1beta1CertificateSpec.


        :param secret_template: The secret_template of this IoCertManagerV1beta1CertificateSpec.  # noqa: E501
    ...
    @property
    def subject(self):
        """Gets the subject of this IoCertManagerV1beta1CertificateSpec.  # noqa: E501


        :return: The subject of this IoCertManagerV1beta1CertificateSpec.  # noqa: E501
    ...
    def subject(self, subject):
        """Sets the subject of this IoCertManagerV1beta1CertificateSpec.


        :param subject: The subject of this IoCertManagerV1beta1CertificateSpec.  # noqa: E501
    ...
    @property
    def uri_sa_ns(self):
        """Gets the uri_sa_ns of this IoCertManagerV1beta1CertificateSpec.  # noqa: E501

        URISANs is a list of URI subjectAltNames to be set on the Certificate.  # noqa: E501

        :return: The uri_sa_ns of this IoCertManagerV1beta1CertificateSpec.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def uri_sa_ns(self, uri_sa_ns):
        """Sets the uri_sa_ns of this IoCertManagerV1beta1CertificateSpec.

        URISANs is a list of URI subjectAltNames to be set on the Certificate.  # noqa: E501

        :param uri_sa_ns: The uri_sa_ns of this IoCertManagerV1beta1CertificateSpec.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def usages(self):
        """Gets the usages of this IoCertManagerV1beta1CertificateSpec.  # noqa: E501
        ...
        :return: The usages of this IoCertManagerV1beta1CertificateSpec.  # noqa: E501
        :rtype: list[str]
        """
        return self._usages
    ...
    def usages(self, usages):
        """Sets the usages of this IoCertManagerV1beta1CertificateSpec.

        Usages is the set of x509 usages that are requested for the certificate. Defaults to `digital signature` and `key encipherment` if not specified.  # noqa: E501

        :param usages: The usages of this IoCertManagerV1beta1CertificateSpec.  # noqa: E501
        :type: list[str]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, IoCertManagerV1beta1CertificateSpec):
            return False
