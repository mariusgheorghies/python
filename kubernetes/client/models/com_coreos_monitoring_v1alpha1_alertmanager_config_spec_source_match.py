...
class ComCoreosMonitoringV1alpha1AlertmanagerConfigSpecSourceMatch(object):
    ...
    def __init__(self, match_type=None, name=None, regex=None, value=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def match_type(self):
        """Gets the match_type of this ComCoreosMonitoringV1alpha1AlertmanagerConfigSpecSourceMatch.  # noqa: E501

        Match operation available with AlertManager >= v0.22.0 and takes precedence over Regex (deprecated) if non-empty.  # noqa: E501

        :return: The match_type of this ComCoreosMonitoringV1alpha1AlertmanagerConfigSpecSourceMatch.  # noqa: E501
        :rtype: str
        """
    ...
    def match_type(self, match_type):
        """Sets the match_type of this ComCoreosMonitoringV1alpha1AlertmanagerConfigSpecSourceMatch.

        Match operation available with AlertManager >= v0.22.0 and takes precedence over Regex (deprecated) if non-empty.  # noqa: E501

        :param match_type: The match_type of this ComCoreosMonitoringV1alpha1AlertmanagerConfigSpecSourceMatch.  # noqa: E501
        :type: str
        """
    ...
    def regex(self):
        ...
        Whether to match on equality (false) or regular-expression (true). Deprecated as of AlertManager >= v0.22.0 where a user should use MatchType instead.  # noqa: E501
