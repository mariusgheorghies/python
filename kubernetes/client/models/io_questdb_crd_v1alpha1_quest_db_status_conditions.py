...
class IoQuestdbCrdV1alpha1QuestDBStatusConditions(object):
    ...
    def __init__(self, last_transition_time=None, message=None, observed_generation=None, reason=None, status=None, type=None, local_vars_configuration=None):  # noqa: E501
        """IoQuestdbCrdV1alpha1QuestDBStatusConditions - a model defined in OpenAPI"""  # noqa: E501
    ...
    def last_transition_time(self):
        """Gets the last_transition_time of this IoQuestdbCrdV1alpha1QuestDBStatusConditions.  # noqa: E501
        ...
        :return: The last_transition_time of this IoQuestdbCrdV1alpha1QuestDBStatusConditions.  # noqa: E501
        :rtype: datetime
        """
    ...
    def last_transition_time(self, last_transition_time):
        """Sets the last_transition_time of this IoQuestdbCrdV1alpha1QuestDBStatusConditions.

        lastTransitionTime is the last time the condition transitioned from one status to another. This should be when the underlying condition changed.  If that is not known, then using the time when the API field changed is acceptable.  # noqa: E501

        :param last_transition_time: The last_transition_time of this IoQuestdbCrdV1alpha1QuestDBStatusConditions.  # noqa: E501
        :type: datetime
        """
    ...
    @property
    def message(self):
        """Gets the message of this IoQuestdbCrdV1alpha1QuestDBStatusConditions.  # noqa: E501

        message is a human readable message indicating details about the transition. This may be an empty string.  # noqa: E501

        :return: The message of this IoQuestdbCrdV1alpha1QuestDBStatusConditions.  # noqa: E501
        :rtype: str
        """
    ...
    def message(self, message):
        """Sets the message of this IoQuestdbCrdV1alpha1QuestDBStatusConditions.

        message is a human readable message indicating details about the transition. This may be an empty string.  # noqa: E501

        :param message: The message of this IoQuestdbCrdV1alpha1QuestDBStatusConditions.  # noqa: E501
        :type: str
        """
    ...
    def observed_generation(self):
        """Gets the observed_generation of this IoQuestdbCrdV1alpha1QuestDBStatusConditions.  # noqa: E501
        ...
        :return: The observed_generation of this IoQuestdbCrdV1alpha1QuestDBStatusConditions.  # noqa: E501
        :rtype: int
        """
    ...
    def observed_generation(self, observed_generation):
        """Sets the observed_generation of this IoQuestdbCrdV1alpha1QuestDBStatusConditions.

        observedGeneration represents the .metadata.generation that the condition was set based upon. For instance, if .metadata.generation is currently 12, but the .status.conditions[x].observedGeneration is 9, the condition is out of date with respect to the current state of the instance.  # noqa: E501

        :param observed_generation: The observed_generation of this IoQuestdbCrdV1alpha1QuestDBStatusConditions.  # noqa: E501
        :type: int
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def reason(self):
        """Gets the reason of this IoQuestdbCrdV1alpha1QuestDBStatusConditions.  # noqa: E501
        ...
        :return: The reason of this IoQuestdbCrdV1alpha1QuestDBStatusConditions.  # noqa: E501
        :rtype: str
        """
        return self._reason
    ...
    def reason(self, reason):
        """Sets the reason of this IoQuestdbCrdV1alpha1QuestDBStatusConditions.

        reason contains a programmatic identifier indicating the reason for the condition's last transition. Producers of specific condition types may define expected values and meanings for this field, and whether the values are considered a guaranteed API. The value should be a CamelCase string. This field may not be empty.  # noqa: E501

        :param reason: The reason of this IoQuestdbCrdV1alpha1QuestDBStatusConditions.  # noqa: E501
        :type: str
        """
    ...
    @property
    def status(self):
        """Gets the status of this IoQuestdbCrdV1alpha1QuestDBStatusConditions.  # noqa: E501

        status of the condition, one of True, False, Unknown.  # noqa: E501

        :return: The status of this IoQuestdbCrdV1alpha1QuestDBStatusConditions.  # noqa: E501
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this IoQuestdbCrdV1alpha1QuestDBStatusConditions.

        status of the condition, one of True, False, Unknown.  # noqa: E501

        :param status: The status of this IoQuestdbCrdV1alpha1QuestDBStatusConditions.  # noqa: E501
        :type: str
        """
    ...
    @property
    def type(self):
        """Gets the type of this IoQuestdbCrdV1alpha1QuestDBStatusConditions.  # noqa: E501

        type of condition in CamelCase or in foo.example.com/CamelCase. --- Many .condition.type values are consistent across resources like Available, but because arbitrary conditions can be useful (see .node.status.conditions), the ability to deconflict is important. The regex it matches is (dns1123SubdomainFmt/)?(qualifiedNameFmt)  # noqa: E501

        :return: The type of this IoQuestdbCrdV1alpha1QuestDBStatusConditions.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this IoQuestdbCrdV1alpha1QuestDBStatusConditions.

        type of condition in CamelCase or in foo.example.com/CamelCase. --- Many .condition.type values are consistent across resources like Available, but because arbitrary conditions can be useful (see .node.status.conditions), the ability to deconflict is important. The regex it matches is (dns1123SubdomainFmt/)?(qualifiedNameFmt)  # noqa: E501

        :param type: The type of this IoQuestdbCrdV1alpha1QuestDBStatusConditions.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, IoQuestdbCrdV1alpha1QuestDBStatusConditions):
            return False
