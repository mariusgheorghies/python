...
class OrgProjectcalicoCrdV1GlobalNetworkPolicySpecSource(object):
    ...
    def __init__(self, namespace_selector=None, nets=None, not_nets=None, not_ports=None, not_selector=None, ports=None, selector=None, service_accounts=None, local_vars_configuration=None):  # noqa: E501
        """OrgProjectcalicoCrdV1GlobalNetworkPolicySpecSource - a model defined in OpenAPI"""  # noqa: E501
    ...
    def namespace_selector(self):
        """Gets the namespace_selector of this OrgProjectcalicoCrdV1GlobalNetworkPolicySpecSource.  # noqa: E501
        ...
        :return: The namespace_selector of this OrgProjectcalicoCrdV1GlobalNetworkPolicySpecSource.  # noqa: E501
        :rtype: str
        """
    ...
    def namespace_selector(self, namespace_selector):
        """Sets the namespace_selector of this OrgProjectcalicoCrdV1GlobalNetworkPolicySpecSource.

        NamespaceSelector is an optional field that contains a selector expression. Only traffic that originates from (or terminates at) endpoints within the selected namespaces will be matched. When both NamespaceSelector and Selector are defined on the same rule, then only workload endpoints that are matched by both selectors will be selected by the rule.   For NetworkPolicy, an empty NamespaceSelector implies that the Selector is limited to selecting only workload endpoints in the same namespace as the NetworkPolicy.   For NetworkPolicy, `global()` NamespaceSelector implies that the Selector is limited to selecting only GlobalNetworkSet or HostEndpoint.   For GlobalNetworkPolicy, an empty NamespaceSelector implies the Selector applies to workload endpoints across all namespaces.  # noqa: E501

        :param namespace_selector: The namespace_selector of this OrgProjectcalicoCrdV1GlobalNetworkPolicySpecSource.  # noqa: E501
        :type: str
        """
    ...
    @property
    def nets(self):
        """Gets the nets of this OrgProjectcalicoCrdV1GlobalNetworkPolicySpecSource.  # noqa: E501
        ...
        :return: The nets of this OrgProjectcalicoCrdV1GlobalNetworkPolicySpecSource.  # noqa: E501
        :rtype: list[str]
        """
        return self._nets
    ...
    @nets.setter
    def nets(self, nets):
        """Sets the nets of this OrgProjectcalicoCrdV1GlobalNetworkPolicySpecSource.

        Nets is an optional field that restricts the rule to only apply to traffic that originates from (or terminates at) IP addresses in any of the given subnets.  # noqa: E501

        :param nets: The nets of this OrgProjectcalicoCrdV1GlobalNetworkPolicySpecSource.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def not_nets(self):
        """Gets the not_nets of this OrgProjectcalicoCrdV1GlobalNetworkPolicySpecSource.  # noqa: E501

        NotNets is the negated version of the Nets field.  # noqa: E501

        :return: The not_nets of this OrgProjectcalicoCrdV1GlobalNetworkPolicySpecSource.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def not_nets(self, not_nets):
        """Sets the not_nets of this OrgProjectcalicoCrdV1GlobalNetworkPolicySpecSource.

        NotNets is the negated version of the Nets field.  # noqa: E501

        :param not_nets: The not_nets of this OrgProjectcalicoCrdV1GlobalNetworkPolicySpecSource.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def not_ports(self):
        """Gets the not_ports of this OrgProjectcalicoCrdV1GlobalNetworkPolicySpecSource.  # noqa: E501
        ...
        :return: The not_ports of this OrgProjectcalicoCrdV1GlobalNetworkPolicySpecSource.  # noqa: E501
        :rtype: list[object]
        """
    ...
    def not_ports(self, not_ports):
        """Sets the not_ports of this OrgProjectcalicoCrdV1GlobalNetworkPolicySpecSource.

        NotPorts is the negated version of the Ports field. Since only some protocols have ports, if any ports are specified it requires the Protocol match in the Rule to be set to \"TCP\" or \"UDP\".  # noqa: E501

        :param not_ports: The not_ports of this OrgProjectcalicoCrdV1GlobalNetworkPolicySpecSource.  # noqa: E501
        :type: list[object]
        """
    ...
    def not_selector(self):
        """Gets the not_selector of this OrgProjectcalicoCrdV1GlobalNetworkPolicySpecSource.  # noqa: E501
        ...
        :return: The not_selector of this OrgProjectcalicoCrdV1GlobalNetworkPolicySpecSource.  # noqa: E501
        :rtype: str
        """
    ...
    def not_selector(self, not_selector):
        """Sets the not_selector of this OrgProjectcalicoCrdV1GlobalNetworkPolicySpecSource.

        NotSelector is the negated version of the Selector field.  See Selector field for subtleties with negated selectors.  # noqa: E501

        :param not_selector: The not_selector of this OrgProjectcalicoCrdV1GlobalNetworkPolicySpecSource.  # noqa: E501
        :type: str
        """
    ...
    @property
    def ports(self):
        """Gets the ports of this OrgProjectcalicoCrdV1GlobalNetworkPolicySpecSource.  # noqa: E501
        ...
        :return: The ports of this OrgProjectcalicoCrdV1GlobalNetworkPolicySpecSource.  # noqa: E501
        :rtype: list[object]
        """
        return self._ports
    ...
    def ports(self, ports):
        """Sets the ports of this OrgProjectcalicoCrdV1GlobalNetworkPolicySpecSource.

        Ports is an optional field that restricts the rule to only apply to traffic that has a source (destination) port that matches one of these ranges/values. This value is a list of integers or strings that represent ranges of ports.   Since only some protocols have ports, if any ports are specified it requires the Protocol match in the Rule to be set to \"TCP\" or \"UDP\".  # noqa: E501

        :param ports: The ports of this OrgProjectcalicoCrdV1GlobalNetworkPolicySpecSource.  # noqa: E501
        :type: list[object]
        """
    ...
    @property
    def selector(self):
        """Gets the selector of this OrgProjectcalicoCrdV1GlobalNetworkPolicySpecSource.  # noqa: E501
        ...
        :return: The selector of this OrgProjectcalicoCrdV1GlobalNetworkPolicySpecSource.  # noqa: E501
        :rtype: str
        """
    ...
    def selector(self, selector):
        """Sets the selector of this OrgProjectcalicoCrdV1GlobalNetworkPolicySpecSource.

        Selector is an optional field that contains a selector expression (see Policy for sample syntax).  Only traffic that originates from (terminates at) endpoints matching the selector will be matched.   Note that: in addition to the negated version of the Selector (see NotSelector below), the selector expression syntax itself supports negation.  The two types of negation are subtly different. One negates the set of matched endpoints, the other negates the whole match:    Selector = \"!has(my_label)\" matches packets that are from other Calico-controlled  endpoints that do not have the label “my_label”.    NotSelector = \"has(my_label)\" matches packets that are not from Calico-controlled  endpoints that do have the label “my_label”.   The effect is that the latter will accept packets from non-Calico sources whereas the former is limited to packets from Calico-controlled endpoints.  # noqa: E501

        :param selector: The selector of this OrgProjectcalicoCrdV1GlobalNetworkPolicySpecSource.  # noqa: E501
        :type: str
        """
    ...
    def service_accounts(self):
        """Gets the service_accounts of this OrgProjectcalicoCrdV1GlobalNetworkPolicySpecSource.  # noqa: E501


        :return: The service_accounts of this OrgProjectcalicoCrdV1GlobalNetworkPolicySpecSource.  # noqa: E501
    ...
    def service_accounts(self, service_accounts):
        """Sets the service_accounts of this OrgProjectcalicoCrdV1GlobalNetworkPolicySpecSource.


        :param service_accounts: The service_accounts of this OrgProjectcalicoCrdV1GlobalNetworkPolicySpecSource.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OrgProjectcalicoCrdV1GlobalNetworkPolicySpecSource):
            return False
