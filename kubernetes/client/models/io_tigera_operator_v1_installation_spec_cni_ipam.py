...
class IoTigeraOperatorV1InstallationSpecCniIpam(object):
    ...
    def __init__(self, type=None, local_vars_configuration=None):  # noqa: E501
        """IoTigeraOperatorV1InstallationSpecCniIpam - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def type(self):
        """Gets the type of this IoTigeraOperatorV1InstallationSpecCniIpam.  # noqa: E501
        ...
        :return: The type of this IoTigeraOperatorV1InstallationSpecCniIpam.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this IoTigeraOperatorV1InstallationSpecCniIpam.

        Specifies the IPAM plugin that will be used in the Calico or Calico Enterprise installation. * For CNI Plugin Calico, this field defaults to Calico. * For CNI Plugin GKE, this field defaults to HostLocal. * For CNI Plugin AzureVNET, this field defaults to AzureVNET. * For CNI Plugin AmazonVPC, this field defaults to AmazonVPC.   The IPAM plugin is installed and configured only if the CNI plugin is set to Calico, for all other values of the CNI plugin the plugin binaries and CNI config is a dependency that is expected to be installed separately.   Default: Calico  # noqa: E501

        :param type: The type of this IoTigeraOperatorV1InstallationSpecCniIpam.  # noqa: E501
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and type is None:  # noqa: E501
            raise ValueError("Invalid value for `type`, must not be `None`")  # noqa: E501
        allowed_values = ["Calico", "HostLocal", "AmazonVPC", "AzureVNET"]  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, IoTigeraOperatorV1InstallationSpecCniIpam):
            return False
