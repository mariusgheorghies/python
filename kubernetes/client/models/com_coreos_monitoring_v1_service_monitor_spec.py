...
class ComCoreosMonitoringV1ServiceMonitorSpec(object):
    ...
    """
    openapi_types = {
        'attach_metadata': 'ComCoreosMonitoringV1ServiceMonitorSpecAttachMetadata',
    ...
    def __init__(self, attach_metadata=None, endpoints=None, job_label=None, label_limit=None, label_name_length_limit=None, label_value_length_limit=None, namespace_selector=None, pod_target_labels=None, sample_limit=None, selector=None, target_labels=None, target_limit=None, local_vars_configuration=None):  # noqa: E501
    ...
    def attach_metadata(self):
        """Gets the attach_metadata of this ComCoreosMonitoringV1ServiceMonitorSpec.  # noqa: E501


        :return: The attach_metadata of this ComCoreosMonitoringV1ServiceMonitorSpec.  # noqa: E501
        :rtype: ComCoreosMonitoringV1ServiceMonitorSpecAttachMetadata
        """
        return self._attach_metadata

    @attach_metadata.setter
    def attach_metadata(self, attach_metadata):
        """Sets the attach_metadata of this ComCoreosMonitoringV1ServiceMonitorSpec.


        :param attach_metadata: The attach_metadata of this ComCoreosMonitoringV1ServiceMonitorSpec.  # noqa: E501
        :type: ComCoreosMonitoringV1ServiceMonitorSpecAttachMetadata
        """
    ...
    def job_label(self):
        ...
        JobLabel selects the label from the associated Kubernetes service which will be used as the `job` label for all metrics.   For example: If in `ServiceMonitor.spec.jobLabel: foo` and in `Service.metadata.labels.foo: bar`, then the `job=\"bar\"` label is added to all metrics.   If the value of this field is empty or if the label doesn't exist for the given Service, the `job` label of the metrics defaults to the name of the Kubernetes Service.  # noqa: E501
    ...
    def target_labels(self):
        ...
        TargetLabels transfers labels from the Kubernetes `Service` onto the created metrics.  # noqa: E501
