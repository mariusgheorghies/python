...
class ComCoreosMonitoringV1PrometheusSpecThanos(object):
    ...
    def __init__(self, base_image=None, grpc_server_tls_config=None, image=None, listen_local=None, log_format=None, log_level=None, min_time=None, object_storage_config=None, object_storage_config_file=None, ready_timeout=None, resources=None, sha=None, tag=None, tracing_config=None, tracing_config_file=None, version=None, volume_mounts=None, local_vars_configuration=None):  # noqa: E501
    ...
    def volume_mounts(self):
        """Gets the volume_mounts of this ComCoreosMonitoringV1PrometheusSpecThanos.  # noqa: E501

        VolumeMounts allows configuration of additional VolumeMounts on the output StatefulSet definition. VolumeMounts specified will be appended to other VolumeMounts in the thanos-sidecar container.  # noqa: E501

        :return: The volume_mounts of this ComCoreosMonitoringV1PrometheusSpecThanos.  # noqa: E501
    ...
    def volume_mounts(self, volume_mounts):
        """Sets the volume_mounts of this ComCoreosMonitoringV1PrometheusSpecThanos.

        VolumeMounts allows configuration of additional VolumeMounts on the output StatefulSet definition. VolumeMounts specified will be appended to other VolumeMounts in the thanos-sidecar container.  # noqa: E501

        :param volume_mounts: The volume_mounts of this ComCoreosMonitoringV1PrometheusSpecThanos.  # noqa: E501
