...
class ComCoreosMonitoringV1ThanosRulerSpec(object):
    ...
    openapi_types = {
        ...
        'alert_relabel_configs': 'ComCoreosMonitoringV1ThanosRulerSpecAlertRelabelConfigs',
    ...
    attribute_map = {
        ...
        'alert_relabel_config_file': 'alertRelabelConfigFile',
        'alert_relabel_configs': 'alertRelabelConfigs',
    ...
    def __init__(self, affinity=None, alert_drop_labels=None, alert_query_url=None, alert_relabel_config_file=None, alert_relabel_configs=None, alertmanagers_config=None, alertmanagers_url=None, containers=None, enforced_namespace_label=None, evaluation_interval=None, external_prefix=None, grpc_server_tls_config=None, image=None, image_pull_secrets=None, init_containers=None, labels=None, listen_local=None, log_format=None, log_level=None, min_ready_seconds=None, node_selector=None, object_storage_config=None, object_storage_config_file=None, paused=None, pod_metadata=None, port_name=None, priority_class_name=None, prometheus_rules_excluded_from_enforce=None, query_config=None, query_endpoints=None, replicas=None, resources=None, retention=None, route_prefix=None, rule_namespace_selector=None, rule_selector=None, security_context=None, service_account_name=None, storage=None, tolerations=None, topology_spread_constraints=None, tracing_config=None, volumes=None, local_vars_configuration=None):  # noqa: E501
        ...
        self._alert_relabel_config_file = None
        self._alert_relabel_configs = None
        ...
        if alert_relabel_config_file is not None:
            self.alert_relabel_config_file = alert_relabel_config_file
        if alert_relabel_configs is not None:
            self.alert_relabel_configs = alert_relabel_configs
    ...
    def alert_drop_labels(self):
        ...
        AlertDropLabels configure the label names which should be dropped in ThanosRuler alerts. The replica label `thanos_ruler_replica` will always be dropped in alerts.  # noqa: E501
    ...
    @property
    def alert_relabel_config_file(self):
        """Gets the alert_relabel_config_file of this ComCoreosMonitoringV1ThanosRulerSpec.  # noqa: E501

        AlertRelabelConfigFile specifies the path of the alert relabeling configuration file. When used alongside with AlertRelabelConfigs, alertRelabelConfigFile takes precedence.  # noqa: E501

        :return: The alert_relabel_config_file of this ComCoreosMonitoringV1ThanosRulerSpec.  # noqa: E501
        :rtype: str
        """
        return self._alert_relabel_config_file

    @alert_relabel_config_file.setter
    def alert_relabel_config_file(self, alert_relabel_config_file):
        """Sets the alert_relabel_config_file of this ComCoreosMonitoringV1ThanosRulerSpec.

        AlertRelabelConfigFile specifies the path of the alert relabeling configuration file. When used alongside with AlertRelabelConfigs, alertRelabelConfigFile takes precedence.  # noqa: E501

        :param alert_relabel_config_file: The alert_relabel_config_file of this ComCoreosMonitoringV1ThanosRulerSpec.  # noqa: E501
        :type: str
        """

        self._alert_relabel_config_file = alert_relabel_config_file

    @property
    def alert_relabel_configs(self):
        """Gets the alert_relabel_configs of this ComCoreosMonitoringV1ThanosRulerSpec.  # noqa: E501


        :return: The alert_relabel_configs of this ComCoreosMonitoringV1ThanosRulerSpec.  # noqa: E501
        :rtype: ComCoreosMonitoringV1ThanosRulerSpecAlertRelabelConfigs
        """
        return self._alert_relabel_configs

    @alert_relabel_configs.setter
    def alert_relabel_configs(self, alert_relabel_configs):
        """Sets the alert_relabel_configs of this ComCoreosMonitoringV1ThanosRulerSpec.


        :param alert_relabel_configs: The alert_relabel_configs of this ComCoreosMonitoringV1ThanosRulerSpec.  # noqa: E501
        :type: ComCoreosMonitoringV1ThanosRulerSpecAlertRelabelConfigs
        """
    ...
    def labels(self):
        ...
        Labels configure the external label pairs to ThanosRuler. A default replica label `thanos_ruler_replica` will be always added  as a label with the value of the pod's name and it will be dropped in the alerts.  # noqa: E501
    ...
    def min_ready_seconds(self):
        """Gets the min_ready_seconds of this ComCoreosMonitoringV1ThanosRulerSpec.  # noqa: E501
        ...
        :return: The min_ready_seconds of this ComCoreosMonitoringV1ThanosRulerSpec.  # noqa: E501
        :rtype: int
        """
    ...
    def min_ready_seconds(self, min_ready_seconds):
        """Sets the min_ready_seconds of this ComCoreosMonitoringV1ThanosRulerSpec.

        Minimum number of seconds for which a newly created pod should be ready without any of its container crashing for it to be considered available. Defaults to 0 (pod will be considered available as soon as it is ready) This is an alpha field and requires enabling StatefulSetMinReadySeconds feature gate.  # noqa: E501

        :param min_ready_seconds: The min_ready_seconds of this ComCoreosMonitoringV1ThanosRulerSpec.  # noqa: E501
        :type: int
        """
