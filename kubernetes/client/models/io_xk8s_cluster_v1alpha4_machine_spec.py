...
class IoXK8sClusterV1alpha4MachineSpec(object):
    ...
    def __init__(self, bootstrap=None, cluster_name=None, failure_domain=None, infrastructure_ref=None, node_drain_timeout=None, provider_id=None, version=None, local_vars_configuration=None):  # noqa: E501
        """IoXK8sClusterV1alpha4MachineSpec - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def bootstrap(self):
        """Gets the bootstrap of this IoXK8sClusterV1alpha4MachineSpec.  # noqa: E501


        :return: The bootstrap of this IoXK8sClusterV1alpha4MachineSpec.  # noqa: E501
    ...
    def bootstrap(self, bootstrap):
        """Sets the bootstrap of this IoXK8sClusterV1alpha4MachineSpec.


        :param bootstrap: The bootstrap of this IoXK8sClusterV1alpha4MachineSpec.  # noqa: E501
    ...
    def cluster_name(self):
        """Gets the cluster_name of this IoXK8sClusterV1alpha4MachineSpec.  # noqa: E501

        ClusterName is the name of the Cluster this object belongs to.  # noqa: E501

        :return: The cluster_name of this IoXK8sClusterV1alpha4MachineSpec.  # noqa: E501
        :rtype: str
        """
    ...
    def cluster_name(self, cluster_name):
        """Sets the cluster_name of this IoXK8sClusterV1alpha4MachineSpec.

        ClusterName is the name of the Cluster this object belongs to.  # noqa: E501

        :param cluster_name: The cluster_name of this IoXK8sClusterV1alpha4MachineSpec.  # noqa: E501
        :type: str
        """
    ...
    def failure_domain(self):
        """Gets the failure_domain of this IoXK8sClusterV1alpha4MachineSpec.  # noqa: E501
        ...
        :return: The failure_domain of this IoXK8sClusterV1alpha4MachineSpec.  # noqa: E501
        :rtype: str
        """
    ...
    def failure_domain(self, failure_domain):
        """Sets the failure_domain of this IoXK8sClusterV1alpha4MachineSpec.

        FailureDomain is the failure domain the machine will be created in. Must match a key in the FailureDomains map stored on the cluster object.  # noqa: E501

        :param failure_domain: The failure_domain of this IoXK8sClusterV1alpha4MachineSpec.  # noqa: E501
        :type: str
        """
    ...
    def infrastructure_ref(self):
        """Gets the infrastructure_ref of this IoXK8sClusterV1alpha4MachineSpec.  # noqa: E501


        :return: The infrastructure_ref of this IoXK8sClusterV1alpha4MachineSpec.  # noqa: E501
    ...
    def infrastructure_ref(self, infrastructure_ref):
        """Sets the infrastructure_ref of this IoXK8sClusterV1alpha4MachineSpec.


        :param infrastructure_ref: The infrastructure_ref of this IoXK8sClusterV1alpha4MachineSpec.  # noqa: E501
    ...
    def node_drain_timeout(self):
        """Gets the node_drain_timeout of this IoXK8sClusterV1alpha4MachineSpec.  # noqa: E501
        ...
        :return: The node_drain_timeout of this IoXK8sClusterV1alpha4MachineSpec.  # noqa: E501
        :rtype: str
        """
    ...
    def node_drain_timeout(self, node_drain_timeout):
        """Sets the node_drain_timeout of this IoXK8sClusterV1alpha4MachineSpec.

        NodeDrainTimeout is the total amount of time that the controller will spend on draining a node. The default value is 0, meaning that the node can be drained without any time limitations. NOTE: NodeDrainTimeout is different from `kubectl drain --timeout`  # noqa: E501

        :param node_drain_timeout: The node_drain_timeout of this IoXK8sClusterV1alpha4MachineSpec.  # noqa: E501
        :type: str
        """
    ...
    def provider_id(self):
        """Gets the provider_id of this IoXK8sClusterV1alpha4MachineSpec.  # noqa: E501
        ...
        :return: The provider_id of this IoXK8sClusterV1alpha4MachineSpec.  # noqa: E501
        :rtype: str
        """
    ...
    def provider_id(self, provider_id):
        """Sets the provider_id of this IoXK8sClusterV1alpha4MachineSpec.

        ProviderID is the identification ID of the machine provided by the provider. This field must match the provider ID as seen on the node object corresponding to this machine. This field is required by higher level consumers of cluster-api. Example use case is cluster autoscaler with cluster-api as provider. Clean-up logic in the autoscaler compares machines to nodes to find out machines at provider which could not get registered as Kubernetes nodes. With cluster-api as a generic out-of-tree provider for autoscaler, this field is required by autoscaler to be able to have a provider view of the list of machines. Another list of nodes is queried from the k8s apiserver and then a comparison is done to find out unregistered machines and are marked for delete. This field will be set by the actuators and consumed by higher level entities like autoscaler that will be interfacing with cluster-api as generic provider.  # noqa: E501

        :param provider_id: The provider_id of this IoXK8sClusterV1alpha4MachineSpec.  # noqa: E501
        :type: str
        """
    ...
    @property
    def version(self):
        """Gets the version of this IoXK8sClusterV1alpha4MachineSpec.  # noqa: E501
        ...
        :return: The version of this IoXK8sClusterV1alpha4MachineSpec.  # noqa: E501
        :rtype: str
        """
    ...
    def version(self, version):
        """Sets the version of this IoXK8sClusterV1alpha4MachineSpec.

        Version defines the desired Kubernetes version. This field is meant to be optionally used by bootstrap providers.  # noqa: E501

        :param version: The version of this IoXK8sClusterV1alpha4MachineSpec.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, IoXK8sClusterV1alpha4MachineSpec):
            return False
