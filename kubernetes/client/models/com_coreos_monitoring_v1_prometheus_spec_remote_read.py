...
class ComCoreosMonitoringV1PrometheusSpecRemoteRead(object):
    ...
    def __init__(self, authorization=None, basic_auth=None, bearer_token=None, bearer_token_file=None, name=None, oauth2=None, proxy_url=None, read_recent=None, remote_timeout=None, required_matchers=None, tls_config=None, url=None, local_vars_configuration=None):  # noqa: E501
