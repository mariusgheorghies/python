...
class ComCoreosMonitoringV1alpha1AlertmanagerConfigSpecRoute(object):
    ...
    attribute_map = {
        ...
        'matchers': 'matchers',
        'mute_time_intervals': 'muteTimeIntervals',
        'receiver': 'receiver',
        'repeat_interval': 'repeatInterval',
        'routes': 'routes'
    }

    def __init__(self, _continue=None, group_by=None, group_interval=None, group_wait=None, matchers=None, mute_time_intervals=None, receiver=None, repeat_interval=None, routes=None, local_vars_configuration=None):  # noqa: E501
    ...
    def group_by(self):
        ...
        List of labels to group by. Labels must not be repeated (unique list). Special label \"...\" (aggregate by all possible labels), if provided, must be the only element in the list.  # noqa: E501
    ...
    def group_interval(self):
        ...
        How long to wait before sending an updated notification. Must match the regular expression`^(([0-9]+)y)?(([0-9]+)w)?(([0-9]+)d)?(([0-9]+)h)?(([0-9]+)m)?(([0-9]+)s)?(([0-9]+)ms)?$` Example: \"5m\"  # noqa: E501
    ...
    def group_wait(self):
        ...
        How long to wait before sending the initial notification. Must match the regular expression`^(([0-9]+)y)?(([0-9]+)w)?(([0-9]+)d)?(([0-9]+)h)?(([0-9]+)m)?(([0-9]+)s)?(([0-9]+)ms)?$` Example: \"30s\"  # noqa: E501
    ...
    def mute_time_intervals(self):
        """Gets the mute_time_intervals of this ComCoreosMonitoringV1alpha1AlertmanagerConfigSpecRoute.  # noqa: E501

        Note: this comment applies to the field definition above but appears below otherwise it gets included in the generated manifest. CRD schema doesn't support self-referential types for now (see https://github.com/kubernetes/kubernetes/issues/62872). We have to use an alternative type to circumvent the limitation. The downside is that the Kube API can't validate the data beyond the fact that it is a valid JSON representation. MuteTimeIntervals is a list of MuteTimeInterval names that will mute this route when matched,  # noqa: E501

        :return: The mute_time_intervals of this ComCoreosMonitoringV1alpha1AlertmanagerConfigSpecRoute.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def mute_time_intervals(self, mute_time_intervals):
        """Sets the mute_time_intervals of this ComCoreosMonitoringV1alpha1AlertmanagerConfigSpecRoute.

        Note: this comment applies to the field definition above but appears below otherwise it gets included in the generated manifest. CRD schema doesn't support self-referential types for now (see https://github.com/kubernetes/kubernetes/issues/62872). We have to use an alternative type to circumvent the limitation. The downside is that the Kube API can't validate the data beyond the fact that it is a valid JSON representation. MuteTimeIntervals is a list of MuteTimeInterval names that will mute this route when matched,  # noqa: E501

        :param mute_time_intervals: The mute_time_intervals of this ComCoreosMonitoringV1alpha1AlertmanagerConfigSpecRoute.  # noqa: E501
        :type: list[str]
        """
    ...
    def repeat_interval(self):
        ...
        How long to wait before repeating the last notification. Must match the regular expression`^(([0-9]+)y)?(([0-9]+)w)?(([0-9]+)d)?(([0-9]+)h)?(([0-9]+)m)?(([0-9]+)s)?(([0-9]+)ms)?$` Example: \"4h\"  # noqa: E501
