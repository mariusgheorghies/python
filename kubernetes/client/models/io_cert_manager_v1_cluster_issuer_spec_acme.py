...
class IoCertManagerV1ClusterIssuerSpecAcme(object):
    ...
    openapi_types = {
        ...
        'solvers': 'list[IoCertManagerV1ClusterIssuerSpecAcmeSolvers]'
    }
    ...
    def __init__(self, disable_account_key_generation=None, email=None, enable_duration_feature=None, external_account_binding=None, preferred_chain=None, private_key_secret_ref=None, server=None, skip_tls_verify=None, solvers=None, local_vars_configuration=None):  # noqa: E501
        """IoCertManagerV1ClusterIssuerSpecAcme - a model defined in OpenAPI"""  # noqa: E501
    ...
    def disable_account_key_generation(self):
        """Gets the disable_account_key_generation of this IoCertManagerV1ClusterIssuerSpecAcme.  # noqa: E501
        ...
        :return: The disable_account_key_generation of this IoCertManagerV1ClusterIssuerSpecAcme.  # noqa: E501
        :rtype: bool
        """
    ...
    def disable_account_key_generation(self, disable_account_key_generation):
        """Sets the disable_account_key_generation of this IoCertManagerV1ClusterIssuerSpecAcme.

        Enables or disables generating a new ACME account key. If true, the Issuer resource will *not* request a new account but will expect the account key to be supplied via an existing secret. If false, the cert-manager system will generate a new ACME account key for the Issuer. Defaults to false.  # noqa: E501

        :param disable_account_key_generation: The disable_account_key_generation of this IoCertManagerV1ClusterIssuerSpecAcme.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def email(self):
        """Gets the email of this IoCertManagerV1ClusterIssuerSpecAcme.  # noqa: E501
        ...
        :return: The email of this IoCertManagerV1ClusterIssuerSpecAcme.  # noqa: E501
        :rtype: str
        """
        return self._email
    ...
    def email(self, email):
        """Sets the email of this IoCertManagerV1ClusterIssuerSpecAcme.

        Email is the email address to be associated with the ACME account. This field is optional, but it is strongly recommended to be set. It will be used to contact you in case of issues with your account or certificates, including expiry notification emails. This field may be updated after the account is initially registered.  # noqa: E501

        :param email: The email of this IoCertManagerV1ClusterIssuerSpecAcme.  # noqa: E501
        :type: str
        """
    ...
    def enable_duration_feature(self):
        """Gets the enable_duration_feature of this IoCertManagerV1ClusterIssuerSpecAcme.  # noqa: E501
        ...
        :return: The enable_duration_feature of this IoCertManagerV1ClusterIssuerSpecAcme.  # noqa: E501
        :rtype: bool
        """
    ...
    def enable_duration_feature(self, enable_duration_feature):
        """Sets the enable_duration_feature of this IoCertManagerV1ClusterIssuerSpecAcme.

        Enables requesting a Not After date on certificates that matches the duration of the certificate. This is not supported by all ACME servers like Let's Encrypt. If set to true when the ACME server does not support it it will create an error on the Order. Defaults to false.  # noqa: E501

        :param enable_duration_feature: The enable_duration_feature of this IoCertManagerV1ClusterIssuerSpecAcme.  # noqa: E501
        :type: bool
        """
    ...
    def external_account_binding(self):
        """Gets the external_account_binding of this IoCertManagerV1ClusterIssuerSpecAcme.  # noqa: E501


        :return: The external_account_binding of this IoCertManagerV1ClusterIssuerSpecAcme.  # noqa: E501
    ...
    def external_account_binding(self, external_account_binding):
        """Sets the external_account_binding of this IoCertManagerV1ClusterIssuerSpecAcme.


        :param external_account_binding: The external_account_binding of this IoCertManagerV1ClusterIssuerSpecAcme.  # noqa: E501
    ...
    def preferred_chain(self):
        """Gets the preferred_chain of this IoCertManagerV1ClusterIssuerSpecAcme.  # noqa: E501
        ...
        :return: The preferred_chain of this IoCertManagerV1ClusterIssuerSpecAcme.  # noqa: E501
        :rtype: str
        """
    ...
    def preferred_chain(self, preferred_chain):
        """Sets the preferred_chain of this IoCertManagerV1ClusterIssuerSpecAcme.

        PreferredChain is the chain to use if the ACME server outputs multiple. PreferredChain is no guarantee that this one gets delivered by the ACME endpoint. For example, for Let's Encrypt's DST crosssign you would use: \"DST Root CA X3\" or \"ISRG Root X1\" for the newer Let's Encrypt root CA. This value picks the first certificate bundle in the ACME alternative chains that has a certificate with this value as its issuer's CN  # noqa: E501

        :param preferred_chain: The preferred_chain of this IoCertManagerV1ClusterIssuerSpecAcme.  # noqa: E501
        :type: str
        """
    ...
    def private_key_secret_ref(self):
        """Gets the private_key_secret_ref of this IoCertManagerV1ClusterIssuerSpecAcme.  # noqa: E501


        :return: The private_key_secret_ref of this IoCertManagerV1ClusterIssuerSpecAcme.  # noqa: E501
    ...
    def private_key_secret_ref(self, private_key_secret_ref):
        """Sets the private_key_secret_ref of this IoCertManagerV1ClusterIssuerSpecAcme.


        :param private_key_secret_ref: The private_key_secret_ref of this IoCertManagerV1ClusterIssuerSpecAcme.  # noqa: E501
    ...
    @property
    def server(self):
        """Gets the server of this IoCertManagerV1ClusterIssuerSpecAcme.  # noqa: E501
        ...
        :return: The server of this IoCertManagerV1ClusterIssuerSpecAcme.  # noqa: E501
        :rtype: str
        """
        return self._server
    ...
    def server(self, server):
        """Sets the server of this IoCertManagerV1ClusterIssuerSpecAcme.

        Server is the URL used to access the ACME server's 'directory' endpoint. For example, for Let's Encrypt's staging endpoint, you would use: \"https://acme-staging-v02.api.letsencrypt.org/directory\". Only ACME v2 endpoints (i.e. RFC 8555) are supported.  # noqa: E501

        :param server: The server of this IoCertManagerV1ClusterIssuerSpecAcme.  # noqa: E501
        :type: str
        """
    ...
    def skip_tls_verify(self):
        """Gets the skip_tls_verify of this IoCertManagerV1ClusterIssuerSpecAcme.  # noqa: E501
        ...
        :return: The skip_tls_verify of this IoCertManagerV1ClusterIssuerSpecAcme.  # noqa: E501
        :rtype: bool
        """
    ...
    def skip_tls_verify(self, skip_tls_verify):
        """Sets the skip_tls_verify of this IoCertManagerV1ClusterIssuerSpecAcme.

        Enables or disables validation of the ACME server TLS certificate. If true, requests to the ACME server will not have their TLS certificate validated (i.e. insecure connections will be allowed). Only enable this option in development environments. The cert-manager system installed roots will be used to verify connections to the ACME server if this is false. Defaults to false.  # noqa: E501

        :param skip_tls_verify: The skip_tls_verify of this IoCertManagerV1ClusterIssuerSpecAcme.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def solvers(self):
        """Gets the solvers of this IoCertManagerV1ClusterIssuerSpecAcme.  # noqa: E501
        ...
        :return: The solvers of this IoCertManagerV1ClusterIssuerSpecAcme.  # noqa: E501
        :rtype: list[IoCertManagerV1ClusterIssuerSpecAcmeSolvers]
        """
        return self._solvers

    @solvers.setter
    def solvers(self, solvers):
        """Sets the solvers of this IoCertManagerV1ClusterIssuerSpecAcme.

        Solvers is a list of challenge solvers that will be used to solve ACME challenges for the matching domains. Solver configurations must be provided in order to obtain certificates from an ACME server. For more information, see: https://cert-manager.io/docs/configuration/acme/  # noqa: E501

        :param solvers: The solvers of this IoCertManagerV1ClusterIssuerSpecAcme.  # noqa: E501
        :type: list[IoCertManagerV1ClusterIssuerSpecAcmeSolvers]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, IoCertManagerV1ClusterIssuerSpecAcme):
            return False
