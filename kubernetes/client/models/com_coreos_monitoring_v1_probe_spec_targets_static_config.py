...
class ComCoreosMonitoringV1ProbeSpecTargetsStaticConfig(object):
    ...
    def relabeling_configs(self):
        ...
        RelabelConfigs to apply to the label set of the targets before it gets scraped. More info: https://prometheus.io/docs/prometheus/latest/configuration/configuration/#relabel_config  # noqa: E501
    ...
    def static(self):
        ...
        The list of hosts to probe.  # noqa: E501
