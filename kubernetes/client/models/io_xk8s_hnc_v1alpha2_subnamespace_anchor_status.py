...
class IoXK8sHncV1alpha2SubnamespaceAnchorStatus(object):
    ...
    def __init__(self, status=None, local_vars_configuration=None):  # noqa: E501
        """IoXK8sHncV1alpha2SubnamespaceAnchorStatus - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def status(self):
        """Gets the status of this IoXK8sHncV1alpha2SubnamespaceAnchorStatus.  # noqa: E501
        ...
        :return: The status of this IoXK8sHncV1alpha2SubnamespaceAnchorStatus.  # noqa: E501
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this IoXK8sHncV1alpha2SubnamespaceAnchorStatus.

        Describes the state of the subnamespace anchor.   Currently, the supported values are:   - \"Missing\": the subnamespace has not been created yet. This should be the default state when the anchor is just created.   - \"Ok\": the subnamespace exists. This is the only good state of the anchor.   - \"Conflict\": a namespace of the same name already exists. The admission controller will attempt to prevent this.   - \"Forbidden\": the anchor was created in a namespace that doesn't allow children, such as kube-system or hnc-system. The admission controller will attempt to prevent this.  # noqa: E501

        :param status: The status of this IoXK8sHncV1alpha2SubnamespaceAnchorStatus.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, IoXK8sHncV1alpha2SubnamespaceAnchorStatus):
            return False
