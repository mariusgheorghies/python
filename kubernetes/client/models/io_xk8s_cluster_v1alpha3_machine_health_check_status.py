...
class IoXK8sClusterV1alpha3MachineHealthCheckStatus(object):
    ...
    def __init__(self, conditions=None, current_healthy=None, expected_machines=None, observed_generation=None, remediations_allowed=None, targets=None, local_vars_configuration=None):  # noqa: E501
        """IoXK8sClusterV1alpha3MachineHealthCheckStatus - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def conditions(self):
        """Gets the conditions of this IoXK8sClusterV1alpha3MachineHealthCheckStatus.  # noqa: E501

        Conditions defines current service state of the MachineHealthCheck.  # noqa: E501

        :return: The conditions of this IoXK8sClusterV1alpha3MachineHealthCheckStatus.  # noqa: E501
    ...
    def conditions(self, conditions):
        """Sets the conditions of this IoXK8sClusterV1alpha3MachineHealthCheckStatus.

        Conditions defines current service state of the MachineHealthCheck.  # noqa: E501

        :param conditions: The conditions of this IoXK8sClusterV1alpha3MachineHealthCheckStatus.  # noqa: E501
    ...
    def current_healthy(self):
        """Gets the current_healthy of this IoXK8sClusterV1alpha3MachineHealthCheckStatus.  # noqa: E501

        total number of healthy machines counted by this machine health check  # noqa: E501

        :return: The current_healthy of this IoXK8sClusterV1alpha3MachineHealthCheckStatus.  # noqa: E501
        :rtype: int
        """
    ...
    def current_healthy(self, current_healthy):
        """Sets the current_healthy of this IoXK8sClusterV1alpha3MachineHealthCheckStatus.

        total number of healthy machines counted by this machine health check  # noqa: E501

        :param current_healthy: The current_healthy of this IoXK8sClusterV1alpha3MachineHealthCheckStatus.  # noqa: E501
        :type: int
        """
    ...
    def expected_machines(self):
        """Gets the expected_machines of this IoXK8sClusterV1alpha3MachineHealthCheckStatus.  # noqa: E501

        total number of machines counted by this machine health check  # noqa: E501

        :return: The expected_machines of this IoXK8sClusterV1alpha3MachineHealthCheckStatus.  # noqa: E501
        :rtype: int
        """
    ...
    def expected_machines(self, expected_machines):
        """Sets the expected_machines of this IoXK8sClusterV1alpha3MachineHealthCheckStatus.

        total number of machines counted by this machine health check  # noqa: E501

        :param expected_machines: The expected_machines of this IoXK8sClusterV1alpha3MachineHealthCheckStatus.  # noqa: E501
        :type: int
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def observed_generation(self):
        """Gets the observed_generation of this IoXK8sClusterV1alpha3MachineHealthCheckStatus.  # noqa: E501

        ObservedGeneration is the latest generation observed by the controller.  # noqa: E501

        :return: The observed_generation of this IoXK8sClusterV1alpha3MachineHealthCheckStatus.  # noqa: E501
        :rtype: int
        """
    ...
    def observed_generation(self, observed_generation):
        """Sets the observed_generation of this IoXK8sClusterV1alpha3MachineHealthCheckStatus.

        ObservedGeneration is the latest generation observed by the controller.  # noqa: E501

        :param observed_generation: The observed_generation of this IoXK8sClusterV1alpha3MachineHealthCheckStatus.  # noqa: E501
        :type: int
        """
    ...
    def remediations_allowed(self):
        """Gets the remediations_allowed of this IoXK8sClusterV1alpha3MachineHealthCheckStatus.  # noqa: E501
        ...
        :return: The remediations_allowed of this IoXK8sClusterV1alpha3MachineHealthCheckStatus.  # noqa: E501
        :rtype: int
        """
    ...
    def remediations_allowed(self, remediations_allowed):
        """Sets the remediations_allowed of this IoXK8sClusterV1alpha3MachineHealthCheckStatus.

        RemediationsAllowed is the number of further remediations allowed by this machine health check before maxUnhealthy short circuiting will be applied  # noqa: E501

        :param remediations_allowed: The remediations_allowed of this IoXK8sClusterV1alpha3MachineHealthCheckStatus.  # noqa: E501
        :type: int
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def targets(self):
        """Gets the targets of this IoXK8sClusterV1alpha3MachineHealthCheckStatus.  # noqa: E501

        Targets shows the current list of machines the machine health check is watching  # noqa: E501

        :return: The targets of this IoXK8sClusterV1alpha3MachineHealthCheckStatus.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def targets(self, targets):
        """Sets the targets of this IoXK8sClusterV1alpha3MachineHealthCheckStatus.

        Targets shows the current list of machines the machine health check is watching  # noqa: E501

        :param targets: The targets of this IoXK8sClusterV1alpha3MachineHealthCheckStatus.  # noqa: E501
        :type: list[str]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, IoXK8sClusterV1alpha3MachineHealthCheckStatus):
            return False
