...
class ComCoreosMonitoringV1alpha1AlertmanagerConfigSpec(object):
    ...
    openapi_types = {
        ...
        'mute_time_intervals': 'list[ComCoreosMonitoringV1alpha1AlertmanagerConfigSpecMuteTimeIntervals]',
    ...
    def __init__(self, inhibit_rules=None, mute_time_intervals=None, receivers=None, route=None, local_vars_configuration=None):  # noqa: E501
    ...
    def mute_time_intervals(self):
        """Gets the mute_time_intervals of this ComCoreosMonitoringV1alpha1AlertmanagerConfigSpec.  # noqa: E501

        List of MuteTimeInterval specifying when the routes should be muted.  # noqa: E501

        :return: The mute_time_intervals of this ComCoreosMonitoringV1alpha1AlertmanagerConfigSpec.  # noqa: E501
        :rtype: list[ComCoreosMonitoringV1alpha1AlertmanagerConfigSpecMuteTimeIntervals]
        """
        return self._mute_time_intervals

    @mute_time_intervals.setter
    def mute_time_intervals(self, mute_time_intervals):
        """Sets the mute_time_intervals of this ComCoreosMonitoringV1alpha1AlertmanagerConfigSpec.

        List of MuteTimeInterval specifying when the routes should be muted.  # noqa: E501

        :param mute_time_intervals: The mute_time_intervals of this ComCoreosMonitoringV1alpha1AlertmanagerConfigSpec.  # noqa: E501
        :type: list[ComCoreosMonitoringV1alpha1AlertmanagerConfigSpecMuteTimeIntervals]
        """
