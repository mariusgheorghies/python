...
class IoXK8sClusterV1alpha3MachineDeploymentSpecSelector(object):
    ...
    def __init__(self, match_expressions=None, match_labels=None, local_vars_configuration=None):  # noqa: E501
        """IoXK8sClusterV1alpha3MachineDeploymentSpecSelector - a model defined in OpenAPI"""  # noqa: E501
    ...
    def match_expressions(self):
        """Gets the match_expressions of this IoXK8sClusterV1alpha3MachineDeploymentSpecSelector.  # noqa: E501

        matchExpressions is a list of label selector requirements. The requirements are ANDed.  # noqa: E501

        :return: The match_expressions of this IoXK8sClusterV1alpha3MachineDeploymentSpecSelector.  # noqa: E501
    ...
    def match_expressions(self, match_expressions):
        """Sets the match_expressions of this IoXK8sClusterV1alpha3MachineDeploymentSpecSelector.

        matchExpressions is a list of label selector requirements. The requirements are ANDed.  # noqa: E501

        :param match_expressions: The match_expressions of this IoXK8sClusterV1alpha3MachineDeploymentSpecSelector.  # noqa: E501
    ...
    def match_labels(self):
        """Gets the match_labels of this IoXK8sClusterV1alpha3MachineDeploymentSpecSelector.  # noqa: E501
        ...
        :return: The match_labels of this IoXK8sClusterV1alpha3MachineDeploymentSpecSelector.  # noqa: E501
        :rtype: dict(str, str)
        """
    ...
    def match_labels(self, match_labels):
        """Sets the match_labels of this IoXK8sClusterV1alpha3MachineDeploymentSpecSelector.

        matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels map is equivalent to an element of matchExpressions, whose key field is \"key\", the operator is \"In\", and the values array contains only \"value\". The requirements are ANDed.  # noqa: E501

        :param match_labels: The match_labels of this IoXK8sClusterV1alpha3MachineDeploymentSpecSelector.  # noqa: E501
        :type: dict(str, str)
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, IoXK8sClusterV1alpha3MachineDeploymentSpecSelector):
            return False
