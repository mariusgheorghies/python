...
class IoXK8sClusterInfrastructureV1alpha3AWSClusterControllerIdentitySpec(object):
    ...
    def __init__(self, allowed_namespaces=None, local_vars_configuration=None):  # noqa: E501
        """IoXK8sClusterInfrastructureV1alpha3AWSClusterControllerIdentitySpec - a model defined in OpenAPI"""  # noqa: E501
    ...
    def allowed_namespaces(self):
        """Gets the allowed_namespaces of this IoXK8sClusterInfrastructureV1alpha3AWSClusterControllerIdentitySpec.  # noqa: E501
        ...
        :return: The allowed_namespaces of this IoXK8sClusterInfrastructureV1alpha3AWSClusterControllerIdentitySpec.  # noqa: E501
        :rtype: object
        """
    ...
    def allowed_namespaces(self, allowed_namespaces):
        """Sets the allowed_namespaces of this IoXK8sClusterInfrastructureV1alpha3AWSClusterControllerIdentitySpec.

        AllowedNamespaces is used to identify which namespaces are allowed to use the identity from. Namespaces can be selected either using an array of namespaces or with label selector. An empty AllowedNamespaces object indicates that AWSClusters can use this identity from any namespace. If this object is nil, no namespaces will be allowed (default behaviour, if this field is not provided) A namespace should be either in the NamespaceList or match with Selector to use the identity.  # noqa: E501

        :param allowed_namespaces: The allowed_namespaces of this IoXK8sClusterInfrastructureV1alpha3AWSClusterControllerIdentitySpec.  # noqa: E501
        :type: object
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, IoXK8sClusterInfrastructureV1alpha3AWSClusterControllerIdentitySpec):
            return False
