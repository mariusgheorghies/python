...
class CertManagerIoV1Api(object):
    ...
    def create_cluster_issuer(self, body, **kwargs):  # noqa: E501
        ...
        :param IoCertManagerV1ClusterIssuer body: (required)
    ...
    def create_cluster_issuer_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(IoCertManagerV1ClusterIssuer, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        return self.api_client.call_api(
            '/apis/cert-manager.io/v1/clusterissuers', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
            ...
            response_type='IoCertManagerV1ClusterIssuer',  # noqa: E501
    ...
    def create_namespaced_certificate(self, namespace, body, **kwargs):  # noqa: E501
        ...
        :param IoCertManagerV1Certificate body: (required)
        :param str pretty: If 'true', then the output is pretty printed.
        :param str dry_run: When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
        :param str field_manager: fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
        :param str field_validation: fieldValidation instructs the server on how to handle objects in the request (POST/PUT/PATCH) containing unknown or duplicate fields, provided that the `ServerSideFieldValidation` feature gate is also enabled. Valid values are: - Ignore: This will ignore any unknown fields that are silently dropped from the object, and will ignore all but the last duplicate field that the decoder encounters. This is the default behavior prior to v1.23 and is the default behavior when the `ServerSideFieldValidation` feature gate is disabled. - Warn: This will send a warning via the standard warning response header for each unknown field that is dropped from the object, and for each duplicate field that is encountered. The request will still succeed if there are no other errors, and will only persist the last of any duplicate fields. This is the default when the `ServerSideFieldValidation` feature gate is enabled. - Strict: This will fail the request with a BadRequest error if any unknown fields would be dropped from the object, or if any duplicate fields are present. The error returned from the server will contain all unknown and duplicate fields encountered.
    ...
    def create_namespaced_certificate_with_http_info(self, namespace, body, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(IoCertManagerV1Certificate, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        return self.api_client.call_api(
            '/apis/cert-manager.io/v1/namespaces/{namespace}/certificates', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='IoCertManagerV1Certificate',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
    ...
    def create_namespaced_certificate_request(self, namespace, body, **kwargs):  # noqa: E501
        ...
        :param async_req bool: execute request asynchronously
        :param str namespace: object name and auth scope, such as for teams and projects (required)
        :param IoCertManagerV1CertificateRequest body: (required)
        :param str pretty: If 'true', then the output is pretty printed.
        :param str dry_run: When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
        :param str field_manager: fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
        :param str field_validation: fieldValidation instructs the server on how to handle objects in the request (POST/PUT/PATCH) containing unknown or duplicate fields, provided that the `ServerSideFieldValidation` feature gate is also enabled. Valid values are: - Ignore: This will ignore any unknown fields that are silently dropped from the object, and will ignore all but the last duplicate field that the decoder encounters. This is the default behavior prior to v1.23 and is the default behavior when the `ServerSideFieldValidation` feature gate is disabled. - Warn: This will send a warning via the standard warning response header for each unknown field that is dropped from the object, and for each duplicate field that is encountered. The request will still succeed if there are no other errors, and will only persist the last of any duplicate fields. This is the default when the `ServerSideFieldValidation` feature gate is enabled. - Strict: This will fail the request with a BadRequest error if any unknown fields would be dropped from the object, or if any duplicate fields are present. The error returned from the server will contain all unknown and duplicate fields encountered.
    ...
    def create_namespaced_certificate_request_with_http_info(self, namespace, body, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(IoCertManagerV1CertificateRequest, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        return self.api_client.call_api(
            '/apis/cert-manager.io/v1/namespaces/{namespace}/certificaterequests', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='IoCertManagerV1CertificateRequest',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
    ...
    def create_namespaced_issuer(self, namespace, body, **kwargs):  # noqa: E501
        ...
        :param async_req bool: execute request asynchronously
        :param str namespace: object name and auth scope, such as for teams and projects (required)
        :param IoCertManagerV1Issuer body: (required)
        :param str pretty: If 'true', then the output is pretty printed.
        :param str dry_run: When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
        :param str field_manager: fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
        :param str field_validation: fieldValidation instructs the server on how to handle objects in the request (POST/PUT/PATCH) containing unknown or duplicate fields, provided that the `ServerSideFieldValidation` feature gate is also enabled. Valid values are: - Ignore: This will ignore any unknown fields that are silently dropped from the object, and will ignore all but the last duplicate field that the decoder encounters. This is the default behavior prior to v1.23 and is the default behavior when the `ServerSideFieldValidation` feature gate is disabled. - Warn: This will send a warning via the standard warning response header for each unknown field that is dropped from the object, and for each duplicate field that is encountered. The request will still succeed if there are no other errors, and will only persist the last of any duplicate fields. This is the default when the `ServerSideFieldValidation` feature gate is enabled. - Strict: This will fail the request with a BadRequest error if any unknown fields would be dropped from the object, or if any duplicate fields are present. The error returned from the server will contain all unknown and duplicate fields encountered.
    ...
    def create_namespaced_issuer_with_http_info(self, namespace, body, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(IoCertManagerV1Issuer, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        return self.api_client.call_api(
            '/apis/cert-manager.io/v1/namespaces/{namespace}/issuers', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='IoCertManagerV1Issuer',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
    ...
    def delete_cluster_issuer_with_http_info(self, name, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/apis/cert-manager.io/v1/clusterissuers/{name}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def delete_collection_cluster_issuer_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/apis/cert-manager.io/v1/clusterissuers', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def delete_collection_namespaced_certificate_with_http_info(self, namespace, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/apis/cert-manager.io/v1/namespaces/{namespace}/certificates', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def delete_collection_namespaced_certificate_request_with_http_info(self, namespace, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/apis/cert-manager.io/v1/namespaces/{namespace}/certificaterequests', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def delete_collection_namespaced_issuer_with_http_info(self, namespace, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/apis/cert-manager.io/v1/namespaces/{namespace}/issuers', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def delete_namespaced_certificate_with_http_info(self, name, namespace, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/apis/cert-manager.io/v1/namespaces/{namespace}/certificates/{name}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def delete_namespaced_certificate_request_with_http_info(self, name, namespace, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/apis/cert-manager.io/v1/namespaces/{namespace}/certificaterequests/{name}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def delete_namespaced_issuer_with_http_info(self, name, namespace, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/apis/cert-manager.io/v1/namespaces/{namespace}/issuers/{name}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def list_certificate_for_all_namespaces_with_http_info(self, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(IoCertManagerV1CertificateList, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        return self.api_client.call_api(
            '/apis/cert-manager.io/v1/certificates', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='IoCertManagerV1CertificateList',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
    ...
    def list_certificate_request_for_all_namespaces_with_http_info(self, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(IoCertManagerV1CertificateRequestList, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        return self.api_client.call_api(
            '/apis/cert-manager.io/v1/certificaterequests', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='IoCertManagerV1CertificateRequestList',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
    ...
    def list_cluster_issuer_with_http_info(self, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(IoCertManagerV1ClusterIssuerList, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        return self.api_client.call_api(
            '/apis/cert-manager.io/v1/clusterissuers', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='IoCertManagerV1ClusterIssuerList',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
    ...
    def list_issuer_for_all_namespaces_with_http_info(self, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(IoCertManagerV1IssuerList, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        return self.api_client.call_api(
            '/apis/cert-manager.io/v1/issuers', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='IoCertManagerV1IssuerList',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
    ...
    def list_namespaced_certificate_with_http_info(self, namespace, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/apis/cert-manager.io/v1/namespaces/{namespace}/certificates', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def list_namespaced_certificate_request_with_http_info(self, namespace, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/apis/cert-manager.io/v1/namespaces/{namespace}/certificaterequests', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def list_namespaced_issuer_with_http_info(self, namespace, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/apis/cert-manager.io/v1/namespaces/{namespace}/issuers', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def patch_cluster_issuer_with_http_info(self, name, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/apis/cert-manager.io/v1/clusterissuers/{name}', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def patch_cluster_issuer_status_with_http_info(self, name, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/apis/cert-manager.io/v1/clusterissuers/{name}/status', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def patch_namespaced_certificate_with_http_info(self, name, namespace, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/apis/cert-manager.io/v1/namespaces/{namespace}/certificates/{name}', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def patch_namespaced_certificate_request_with_http_info(self, name, namespace, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/apis/cert-manager.io/v1/namespaces/{namespace}/certificaterequests/{name}', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def patch_namespaced_certificate_request_status_with_http_info(self, name, namespace, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/apis/cert-manager.io/v1/namespaces/{namespace}/certificaterequests/{name}/status', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def patch_namespaced_certificate_status_with_http_info(self, name, namespace, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/apis/cert-manager.io/v1/namespaces/{namespace}/certificates/{name}/status', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def patch_namespaced_issuer_with_http_info(self, name, namespace, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/apis/cert-manager.io/v1/namespaces/{namespace}/issuers/{name}', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def patch_namespaced_issuer_status_with_http_info(self, name, namespace, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/apis/cert-manager.io/v1/namespaces/{namespace}/issuers/{name}/status', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def read_cluster_issuer_with_http_info(self, name, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/apis/cert-manager.io/v1/clusterissuers/{name}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def read_cluster_issuer_status_with_http_info(self, name, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/apis/cert-manager.io/v1/clusterissuers/{name}/status', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def read_namespaced_certificate_with_http_info(self, name, namespace, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/apis/cert-manager.io/v1/namespaces/{namespace}/certificates/{name}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def read_namespaced_certificate_request_with_http_info(self, name, namespace, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/apis/cert-manager.io/v1/namespaces/{namespace}/certificaterequests/{name}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def read_namespaced_certificate_request_status_with_http_info(self, name, namespace, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/apis/cert-manager.io/v1/namespaces/{namespace}/certificaterequests/{name}/status', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def read_namespaced_certificate_status_with_http_info(self, name, namespace, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/apis/cert-manager.io/v1/namespaces/{namespace}/certificates/{name}/status', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def read_namespaced_issuer_with_http_info(self, name, namespace, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/apis/cert-manager.io/v1/namespaces/{namespace}/issuers/{name}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def read_namespaced_issuer_status_with_http_info(self, name, namespace, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/apis/cert-manager.io/v1/namespaces/{namespace}/issuers/{name}/status', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def replace_cluster_issuer_with_http_info(self, name, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/apis/cert-manager.io/v1/clusterissuers/{name}', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def replace_cluster_issuer_status_with_http_info(self, name, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/apis/cert-manager.io/v1/clusterissuers/{name}/status', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def replace_namespaced_certificate_with_http_info(self, name, namespace, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/apis/cert-manager.io/v1/namespaces/{namespace}/certificates/{name}', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def replace_namespaced_certificate_request_with_http_info(self, name, namespace, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/apis/cert-manager.io/v1/namespaces/{namespace}/certificaterequests/{name}', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def replace_namespaced_certificate_request_status_with_http_info(self, name, namespace, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/apis/cert-manager.io/v1/namespaces/{namespace}/certificaterequests/{name}/status', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def replace_namespaced_certificate_status_with_http_info(self, name, namespace, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/apis/cert-manager.io/v1/namespaces/{namespace}/certificates/{name}/status', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def replace_namespaced_issuer_with_http_info(self, name, namespace, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/apis/cert-manager.io/v1/namespaces/{namespace}/issuers/{name}', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def replace_namespaced_issuer_status_with_http_info(self, name, namespace, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/apis/cert-manager.io/v1/namespaces/{namespace}/issuers/{name}/status', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
