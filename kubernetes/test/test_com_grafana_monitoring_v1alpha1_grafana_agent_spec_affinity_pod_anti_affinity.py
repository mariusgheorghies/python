...
from kubernetes.client.models.com_grafana_monitoring_v1alpha1_grafana_agent_spec_affinity_pod_anti_affinity import ComGrafanaMonitoringV1alpha1GrafanaAgentSpecAffinityPodAntiAffinity  # noqa: E501
from kubernetes.client.rest import ApiException

class TestComGrafanaMonitoringV1alpha1GrafanaAgentSpecAffinityPodAntiAffinity(unittest.TestCase):
    """ComGrafanaMonitoringV1alpha1GrafanaAgentSpecAffinityPodAntiAffinity unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test ComGrafanaMonitoringV1alpha1GrafanaAgentSpecAffinityPodAntiAffinity
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = kubernetes.client.models.com_grafana_monitoring_v1alpha1_grafana_agent_spec_affinity_pod_anti_affinity.ComGrafanaMonitoringV1alpha1GrafanaAgentSpecAffinityPodAntiAffinity()  # noqa: E501
        if include_optional :
            return ComGrafanaMonitoringV1alpha1GrafanaAgentSpecAffinityPodAntiAffinity(
    ...
    def testComGrafanaMonitoringV1alpha1GrafanaAgentSpecAffinityPodAntiAffinity(self):
        """Test ComGrafanaMonitoringV1alpha1GrafanaAgentSpecAffinityPodAntiAffinity"""
