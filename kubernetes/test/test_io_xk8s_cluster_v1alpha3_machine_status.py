...
from kubernetes.client.models.io_xk8s_cluster_v1alpha3_machine_status import IoXK8sClusterV1alpha3MachineStatus  # noqa: E501
from kubernetes.client.rest import ApiException

class TestIoXK8sClusterV1alpha3MachineStatus(unittest.TestCase):
    """IoXK8sClusterV1alpha3MachineStatus unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test IoXK8sClusterV1alpha3MachineStatus
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = kubernetes.client.models.io_xk8s_cluster_v1alpha3_machine_status.IoXK8sClusterV1alpha3MachineStatus()  # noqa: E501
        if include_optional :
            return IoXK8sClusterV1alpha3MachineStatus(
                addresses = [
    ...
    def testIoXK8sClusterV1alpha3MachineStatus(self):
        """Test IoXK8sClusterV1alpha3MachineStatus"""
