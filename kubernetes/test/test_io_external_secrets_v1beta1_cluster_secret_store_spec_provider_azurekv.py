...
from kubernetes.client.models.io_external_secrets_v1beta1_cluster_secret_store_spec_provider_azurekv import IoExternalSecretsV1beta1ClusterSecretStoreSpecProviderAzurekv  # noqa: E501
from kubernetes.client.rest import ApiException

class TestIoExternalSecretsV1beta1ClusterSecretStoreSpecProviderAzurekv(unittest.TestCase):
    """IoExternalSecretsV1beta1ClusterSecretStoreSpecProviderAzurekv unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test IoExternalSecretsV1beta1ClusterSecretStoreSpecProviderAzurekv
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = kubernetes.client.models.io_external_secrets_v1beta1_cluster_secret_store_spec_provider_azurekv.IoExternalSecretsV1beta1ClusterSecretStoreSpecProviderAzurekv()  # noqa: E501
        if include_optional :
            return IoExternalSecretsV1beta1ClusterSecretStoreSpecProviderAzurekv(
    ...
    def testIoExternalSecretsV1beta1ClusterSecretStoreSpecProviderAzurekv(self):
        """Test IoExternalSecretsV1beta1ClusterSecretStoreSpecProviderAzurekv"""
