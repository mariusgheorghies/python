...
from kubernetes.client.models.io_xk8s_cluster_infrastructure_v1beta1_aws_cluster_status_bastion import IoXK8sClusterInfrastructureV1beta1AWSClusterStatusBastion  # noqa: E501
from kubernetes.client.rest import ApiException

class TestIoXK8sClusterInfrastructureV1beta1AWSClusterStatusBastion(unittest.TestCase):
    """IoXK8sClusterInfrastructureV1beta1AWSClusterStatusBastion unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test IoXK8sClusterInfrastructureV1beta1AWSClusterStatusBastion
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = kubernetes.client.models.io_xk8s_cluster_infrastructure_v1beta1_aws_cluster_status_bastion.IoXK8sClusterInfrastructureV1beta1AWSClusterStatusBastion()  # noqa: E501
        if include_optional :
            return IoXK8sClusterInfrastructureV1beta1AWSClusterStatusBastion(
                addresses = [
    ...
    def testIoXK8sClusterInfrastructureV1beta1AWSClusterStatusBastion(self):
        """Test IoXK8sClusterInfrastructureV1beta1AWSClusterStatusBastion"""
