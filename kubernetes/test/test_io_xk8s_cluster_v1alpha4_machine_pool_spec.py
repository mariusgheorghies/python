...
from kubernetes.client.models.io_xk8s_cluster_v1alpha4_machine_pool_spec import IoXK8sClusterV1alpha4MachinePoolSpec  # noqa: E501
from kubernetes.client.rest import ApiException

class TestIoXK8sClusterV1alpha4MachinePoolSpec(unittest.TestCase):
    """IoXK8sClusterV1alpha4MachinePoolSpec unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test IoXK8sClusterV1alpha4MachinePoolSpec
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = kubernetes.client.models.io_xk8s_cluster_v1alpha4_machine_pool_spec.IoXK8sClusterV1alpha4MachinePoolSpec()  # noqa: E501
        if include_optional :
            return IoXK8sClusterV1alpha4MachinePoolSpec(
                cluster_name = '0', 
                failure_domains = [
                    '0'
                    ], 
    ...
    def testIoXK8sClusterV1alpha4MachinePoolSpec(self):
        """Test IoXK8sClusterV1alpha4MachinePoolSpec"""
