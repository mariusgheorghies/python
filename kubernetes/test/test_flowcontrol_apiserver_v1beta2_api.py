...
from kubernetes.client.api.flowcontrol_apiserver_v1beta2_api import FlowcontrolApiserverV1beta2Api  # noqa: E501
...
class TestFlowcontrolApiserverV1beta2Api(unittest.TestCase):
    ...
    def setUp(self):
        self.api = kubernetes.client.api.flowcontrol_apiserver_v1beta2_api.FlowcontrolApiserverV1beta2Api()  # noqa: E501
