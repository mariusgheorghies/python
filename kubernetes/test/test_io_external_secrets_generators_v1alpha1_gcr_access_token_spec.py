...
from kubernetes.client.models.io_external_secrets_generators_v1alpha1_gcr_access_token_spec import IoExternalSecretsGeneratorsV1alpha1GCRAccessTokenSpec  # noqa: E501
from kubernetes.client.rest import ApiException

class TestIoExternalSecretsGeneratorsV1alpha1GCRAccessTokenSpec(unittest.TestCase):
    """IoExternalSecretsGeneratorsV1alpha1GCRAccessTokenSpec unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test IoExternalSecretsGeneratorsV1alpha1GCRAccessTokenSpec
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = kubernetes.client.models.io_external_secrets_generators_v1alpha1_gcr_access_token_spec.IoExternalSecretsGeneratorsV1alpha1GCRAccessTokenSpec()  # noqa: E501
        if include_optional :
            return IoExternalSecretsGeneratorsV1alpha1GCRAccessTokenSpec(
    ...
    def testIoExternalSecretsGeneratorsV1alpha1GCRAccessTokenSpec(self):
        """Test IoExternalSecretsGeneratorsV1alpha1GCRAccessTokenSpec"""
