...
from kubernetes.client.models.io_cert_manager_v1alpha3_cluster_issuer_list import IoCertManagerV1alpha3ClusterIssuerList  # noqa: E501
from kubernetes.client.rest import ApiException

class TestIoCertManagerV1alpha3ClusterIssuerList(unittest.TestCase):
    """IoCertManagerV1alpha3ClusterIssuerList unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test IoCertManagerV1alpha3ClusterIssuerList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = kubernetes.client.models.io_cert_manager_v1alpha3_cluster_issuer_list.IoCertManagerV1alpha3ClusterIssuerList()  # noqa: E501
        if include_optional :
            return IoCertManagerV1alpha3ClusterIssuerList(
                api_version = '0', 
                items = [
                    kubernetes.client.models.io/cert_manager/v1alpha3/cluster_issuer.io.cert-manager.v1alpha3.ClusterIssuer(
                        api_version = '0', 
                        kind = '0', 
    ...
    def testIoCertManagerV1alpha3ClusterIssuerList(self):
        """Test IoCertManagerV1alpha3ClusterIssuerList"""
