...
from kubernetes.client.models.com_grafana_monitoring_v1alpha1_grafana_agent_spec_storage_volume_claim_template_spec import ComGrafanaMonitoringV1alpha1GrafanaAgentSpecStorageVolumeClaimTemplateSpec  # noqa: E501
from kubernetes.client.rest import ApiException

class TestComGrafanaMonitoringV1alpha1GrafanaAgentSpecStorageVolumeClaimTemplateSpec(unittest.TestCase):
    """ComGrafanaMonitoringV1alpha1GrafanaAgentSpecStorageVolumeClaimTemplateSpec unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test ComGrafanaMonitoringV1alpha1GrafanaAgentSpecStorageVolumeClaimTemplateSpec
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = kubernetes.client.models.com_grafana_monitoring_v1alpha1_grafana_agent_spec_storage_volume_claim_template_spec.ComGrafanaMonitoringV1alpha1GrafanaAgentSpecStorageVolumeClaimTemplateSpec()  # noqa: E501
        if include_optional :
            return ComGrafanaMonitoringV1alpha1GrafanaAgentSpecStorageVolumeClaimTemplateSpec(
                access_modes = [
                    '0'
                    ], 
    ...
    def testComGrafanaMonitoringV1alpha1GrafanaAgentSpecStorageVolumeClaimTemplateSpec(self):
        """Test ComGrafanaMonitoringV1alpha1GrafanaAgentSpecStorageVolumeClaimTemplateSpec"""
