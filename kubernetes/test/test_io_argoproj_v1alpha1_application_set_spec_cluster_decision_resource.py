...
from kubernetes.client.models.io_argoproj_v1alpha1_application_set_spec_cluster_decision_resource import IoArgoprojV1alpha1ApplicationSetSpecClusterDecisionResource  # noqa: E501
from kubernetes.client.rest import ApiException

class TestIoArgoprojV1alpha1ApplicationSetSpecClusterDecisionResource(unittest.TestCase):
    """IoArgoprojV1alpha1ApplicationSetSpecClusterDecisionResource unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test IoArgoprojV1alpha1ApplicationSetSpecClusterDecisionResource
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = kubernetes.client.models.io_argoproj_v1alpha1_application_set_spec_cluster_decision_resource.IoArgoprojV1alpha1ApplicationSetSpecClusterDecisionResource()  # noqa: E501
        if include_optional :
            return IoArgoprojV1alpha1ApplicationSetSpecClusterDecisionResource(
                config_map_ref = '0', 
    ...
    def testIoArgoprojV1alpha1ApplicationSetSpecClusterDecisionResource(self):
        """Test IoArgoprojV1alpha1ApplicationSetSpecClusterDecisionResource"""
