...
from kubernetes.client.models.com_grafana_monitoring_v1alpha1_grafana_agent_spec_storage_ephemeral import ComGrafanaMonitoringV1alpha1GrafanaAgentSpecStorageEphemeral  # noqa: E501
from kubernetes.client.rest import ApiException

class TestComGrafanaMonitoringV1alpha1GrafanaAgentSpecStorageEphemeral(unittest.TestCase):
    """ComGrafanaMonitoringV1alpha1GrafanaAgentSpecStorageEphemeral unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test ComGrafanaMonitoringV1alpha1GrafanaAgentSpecStorageEphemeral
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = kubernetes.client.models.com_grafana_monitoring_v1alpha1_grafana_agent_spec_storage_ephemeral.ComGrafanaMonitoringV1alpha1GrafanaAgentSpecStorageEphemeral()  # noqa: E501
        if include_optional :
            return ComGrafanaMonitoringV1alpha1GrafanaAgentSpecStorageEphemeral(
    ...
    def testComGrafanaMonitoringV1alpha1GrafanaAgentSpecStorageEphemeral(self):
        """Test ComGrafanaMonitoringV1alpha1GrafanaAgentSpecStorageEphemeral"""
