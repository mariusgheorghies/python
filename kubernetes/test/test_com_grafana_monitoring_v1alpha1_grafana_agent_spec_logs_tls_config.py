...
from kubernetes.client.models.com_grafana_monitoring_v1alpha1_grafana_agent_spec_logs_tls_config import ComGrafanaMonitoringV1alpha1GrafanaAgentSpecLogsTlsConfig  # noqa: E501
from kubernetes.client.rest import ApiException

class TestComGrafanaMonitoringV1alpha1GrafanaAgentSpecLogsTlsConfig(unittest.TestCase):
    """ComGrafanaMonitoringV1alpha1GrafanaAgentSpecLogsTlsConfig unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test ComGrafanaMonitoringV1alpha1GrafanaAgentSpecLogsTlsConfig
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = kubernetes.client.models.com_grafana_monitoring_v1alpha1_grafana_agent_spec_logs_tls_config.ComGrafanaMonitoringV1alpha1GrafanaAgentSpecLogsTlsConfig()  # noqa: E501
        if include_optional :
            return ComGrafanaMonitoringV1alpha1GrafanaAgentSpecLogsTlsConfig(
    ...
    def testComGrafanaMonitoringV1alpha1GrafanaAgentSpecLogsTlsConfig(self):
        """Test ComGrafanaMonitoringV1alpha1GrafanaAgentSpecLogsTlsConfig"""
