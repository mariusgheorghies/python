...
from kubernetes.client.models.io_external_secrets_v1alpha1_secret_store_list import IoExternalSecretsV1alpha1SecretStoreList  # noqa: E501
from kubernetes.client.rest import ApiException

class TestIoExternalSecretsV1alpha1SecretStoreList(unittest.TestCase):
    """IoExternalSecretsV1alpha1SecretStoreList unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test IoExternalSecretsV1alpha1SecretStoreList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = kubernetes.client.models.io_external_secrets_v1alpha1_secret_store_list.IoExternalSecretsV1alpha1SecretStoreList()  # noqa: E501
        if include_optional :
            return IoExternalSecretsV1alpha1SecretStoreList(
                api_version = '0', 
                items = [
                    kubernetes.client.models.io/external_secrets/v1alpha1/secret_store.io.external-secrets.v1alpha1.SecretStore(
                        api_version = '0', 
                        kind = '0', 
    ...
    def testIoExternalSecretsV1alpha1SecretStoreList(self):
        """Test IoExternalSecretsV1alpha1SecretStoreList"""
