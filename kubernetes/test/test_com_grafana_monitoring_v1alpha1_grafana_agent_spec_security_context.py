...
from kubernetes.client.models.com_grafana_monitoring_v1alpha1_grafana_agent_spec_security_context import ComGrafanaMonitoringV1alpha1GrafanaAgentSpecSecurityContext  # noqa: E501
from kubernetes.client.rest import ApiException

class TestComGrafanaMonitoringV1alpha1GrafanaAgentSpecSecurityContext(unittest.TestCase):
    """ComGrafanaMonitoringV1alpha1GrafanaAgentSpecSecurityContext unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test ComGrafanaMonitoringV1alpha1GrafanaAgentSpecSecurityContext
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = kubernetes.client.models.com_grafana_monitoring_v1alpha1_grafana_agent_spec_security_context.ComGrafanaMonitoringV1alpha1GrafanaAgentSpecSecurityContext()  # noqa: E501
        if include_optional :
            return ComGrafanaMonitoringV1alpha1GrafanaAgentSpecSecurityContext(
                fs_group = 56, 
    ...
    def testComGrafanaMonitoringV1alpha1GrafanaAgentSpecSecurityContext(self):
        """Test ComGrafanaMonitoringV1alpha1GrafanaAgentSpecSecurityContext"""
