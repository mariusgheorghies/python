...
from kubernetes.client.models.io_xk8s_cluster_v1alpha4_machine_deployment_spec_template import IoXK8sClusterV1alpha4MachineDeploymentSpecTemplate  # noqa: E501
from kubernetes.client.rest import ApiException

class TestIoXK8sClusterV1alpha4MachineDeploymentSpecTemplate(unittest.TestCase):
    """IoXK8sClusterV1alpha4MachineDeploymentSpecTemplate unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test IoXK8sClusterV1alpha4MachineDeploymentSpecTemplate
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = kubernetes.client.models.io_xk8s_cluster_v1alpha4_machine_deployment_spec_template.IoXK8sClusterV1alpha4MachineDeploymentSpecTemplate()  # noqa: E501
        if include_optional :
            return IoXK8sClusterV1alpha4MachineDeploymentSpecTemplate(
    ...
    def testIoXK8sClusterV1alpha4MachineDeploymentSpecTemplate(self):
        """Test IoXK8sClusterV1alpha4MachineDeploymentSpecTemplate"""
