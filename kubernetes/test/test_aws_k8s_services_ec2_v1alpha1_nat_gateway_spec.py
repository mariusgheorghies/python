...
from kubernetes.client.models.aws_k8s_services_ec2_v1alpha1_nat_gateway_spec import AwsK8sServicesEc2V1alpha1NATGatewaySpec  # noqa: E501
from kubernetes.client.rest import ApiException

class TestAwsK8sServicesEc2V1alpha1NATGatewaySpec(unittest.TestCase):
    """AwsK8sServicesEc2V1alpha1NATGatewaySpec unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test AwsK8sServicesEc2V1alpha1NATGatewaySpec
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = kubernetes.client.models.aws_k8s_services_ec2_v1alpha1_nat_gateway_spec.AwsK8sServicesEc2V1alpha1NATGatewaySpec()  # noqa: E501
        if include_optional :
            return AwsK8sServicesEc2V1alpha1NATGatewaySpec(
                allocation_id = '0', 
    ...
    def testAwsK8sServicesEc2V1alpha1NATGatewaySpec(self):
        """Test AwsK8sServicesEc2V1alpha1NATGatewaySpec"""
