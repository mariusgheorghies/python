...
from kubernetes.client.models.io_cert_manager_v1alpha3_certificate_spec import IoCertManagerV1alpha3CertificateSpec  # noqa: E501
from kubernetes.client.rest import ApiException

class TestIoCertManagerV1alpha3CertificateSpec(unittest.TestCase):
    """IoCertManagerV1alpha3CertificateSpec unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test IoCertManagerV1alpha3CertificateSpec
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = kubernetes.client.models.io_cert_manager_v1alpha3_certificate_spec.IoCertManagerV1alpha3CertificateSpec()  # noqa: E501
        if include_optional :
            return IoCertManagerV1alpha3CertificateSpec(
                common_name = '0', 
                dns_names = [
                    '0'
                    ], 
    ...
    def testIoCertManagerV1alpha3CertificateSpec(self):
        """Test IoCertManagerV1alpha3CertificateSpec"""
