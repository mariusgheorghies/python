...
from kubernetes.client.models.io_argoproj_v1alpha1_application_set_spec_cluster_decision_resource_template_spec_sync_policy import IoArgoprojV1alpha1ApplicationSetSpecClusterDecisionResourceTemplateSpecSyncPolicy  # noqa: E501
from kubernetes.client.rest import ApiException

class TestIoArgoprojV1alpha1ApplicationSetSpecClusterDecisionResourceTemplateSpecSyncPolicy(unittest.TestCase):
    """IoArgoprojV1alpha1ApplicationSetSpecClusterDecisionResourceTemplateSpecSyncPolicy unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test IoArgoprojV1alpha1ApplicationSetSpecClusterDecisionResourceTemplateSpecSyncPolicy
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = kubernetes.client.models.io_argoproj_v1alpha1_application_set_spec_cluster_decision_resource_template_spec_sync_policy.IoArgoprojV1alpha1ApplicationSetSpecClusterDecisionResourceTemplateSpecSyncPolicy()  # noqa: E501
        if include_optional :
            return IoArgoprojV1alpha1ApplicationSetSpecClusterDecisionResourceTemplateSpecSyncPolicy(
    ...
    def testIoArgoprojV1alpha1ApplicationSetSpecClusterDecisionResourceTemplateSpecSyncPolicy(self):
        """Test IoArgoprojV1alpha1ApplicationSetSpecClusterDecisionResourceTemplateSpecSyncPolicy"""
