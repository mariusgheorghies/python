...
from kubernetes.client.models.io_xk8s_cluster_bootstrap_v1alpha4_kubeadm_config_template_spec_template import IoXK8sClusterBootstrapV1alpha4KubeadmConfigTemplateSpecTemplate  # noqa: E501
from kubernetes.client.rest import ApiException

class TestIoXK8sClusterBootstrapV1alpha4KubeadmConfigTemplateSpecTemplate(unittest.TestCase):
    """IoXK8sClusterBootstrapV1alpha4KubeadmConfigTemplateSpecTemplate unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test IoXK8sClusterBootstrapV1alpha4KubeadmConfigTemplateSpecTemplate
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = kubernetes.client.models.io_xk8s_cluster_bootstrap_v1alpha4_kubeadm_config_template_spec_template.IoXK8sClusterBootstrapV1alpha4KubeadmConfigTemplateSpecTemplate()  # noqa: E501
        if include_optional :
            return IoXK8sClusterBootstrapV1alpha4KubeadmConfigTemplateSpecTemplate(
    ...
    def testIoXK8sClusterBootstrapV1alpha4KubeadmConfigTemplateSpecTemplate(self):
        """Test IoXK8sClusterBootstrapV1alpha4KubeadmConfigTemplateSpecTemplate"""
