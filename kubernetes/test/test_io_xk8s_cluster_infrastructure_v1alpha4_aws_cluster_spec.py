...
from kubernetes.client.models.io_xk8s_cluster_infrastructure_v1alpha4_aws_cluster_spec import IoXK8sClusterInfrastructureV1alpha4AWSClusterSpec  # noqa: E501
from kubernetes.client.rest import ApiException

class TestIoXK8sClusterInfrastructureV1alpha4AWSClusterSpec(unittest.TestCase):
    """IoXK8sClusterInfrastructureV1alpha4AWSClusterSpec unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test IoXK8sClusterInfrastructureV1alpha4AWSClusterSpec
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = kubernetes.client.models.io_xk8s_cluster_infrastructure_v1alpha4_aws_cluster_spec.IoXK8sClusterInfrastructureV1alpha4AWSClusterSpec()  # noqa: E501
        if include_optional :
            return IoXK8sClusterInfrastructureV1alpha4AWSClusterSpec(
                additional_tags = {
                    'key' : '0'
                    }, 
    ...
    def testIoXK8sClusterInfrastructureV1alpha4AWSClusterSpec(self):
        """Test IoXK8sClusterInfrastructureV1alpha4AWSClusterSpec"""
