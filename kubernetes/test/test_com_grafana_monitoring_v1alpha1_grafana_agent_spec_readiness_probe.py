...
from kubernetes.client.models.com_grafana_monitoring_v1alpha1_grafana_agent_spec_readiness_probe import ComGrafanaMonitoringV1alpha1GrafanaAgentSpecReadinessProbe  # noqa: E501
from kubernetes.client.rest import ApiException

class TestComGrafanaMonitoringV1alpha1GrafanaAgentSpecReadinessProbe(unittest.TestCase):
    """ComGrafanaMonitoringV1alpha1GrafanaAgentSpecReadinessProbe unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test ComGrafanaMonitoringV1alpha1GrafanaAgentSpecReadinessProbe
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = kubernetes.client.models.com_grafana_monitoring_v1alpha1_grafana_agent_spec_readiness_probe.ComGrafanaMonitoringV1alpha1GrafanaAgentSpecReadinessProbe()  # noqa: E501
        if include_optional :
            return ComGrafanaMonitoringV1alpha1GrafanaAgentSpecReadinessProbe(
    ...
    def testComGrafanaMonitoringV1alpha1GrafanaAgentSpecReadinessProbe(self):
        """Test ComGrafanaMonitoringV1alpha1GrafanaAgentSpecReadinessProbe"""
