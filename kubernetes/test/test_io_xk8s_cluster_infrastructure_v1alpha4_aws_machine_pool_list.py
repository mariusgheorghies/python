...
from kubernetes.client.models.io_xk8s_cluster_infrastructure_v1alpha4_aws_machine_pool_list import IoXK8sClusterInfrastructureV1alpha4AWSMachinePoolList  # noqa: E501
from kubernetes.client.rest import ApiException

class TestIoXK8sClusterInfrastructureV1alpha4AWSMachinePoolList(unittest.TestCase):
    """IoXK8sClusterInfrastructureV1alpha4AWSMachinePoolList unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test IoXK8sClusterInfrastructureV1alpha4AWSMachinePoolList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = kubernetes.client.models.io_xk8s_cluster_infrastructure_v1alpha4_aws_machine_pool_list.IoXK8sClusterInfrastructureV1alpha4AWSMachinePoolList()  # noqa: E501
        if include_optional :
            return IoXK8sClusterInfrastructureV1alpha4AWSMachinePoolList(
                api_version = '0', 
                items = [
                    kubernetes.client.models.io/x_k8s/cluster/infrastructure/v1alpha4/aws_machine_pool.io.x-k8s.cluster.infrastructure.v1alpha4.AWSMachinePool(
                        api_version = '0', 
                        kind = '0', 
                        metadata = kubernetes.client.models.v1/object_meta_v2.v1.ObjectMeta_v2(
                            ...
                            self_link = '0', 
                            uid = '0', ), 
                        spec = kubernetes.client.models.io_x_k8s_cluster_infrastructure_v1alpha4_aws_machine_pool_spec.io_x_k8s_cluster_infrastructure_v1alpha4_AWSMachinePool_spec(
                            additional_tags = {
                                'key' : '0'
                                }, 
                            availability_zones = [
                            ...
                            aws_launch_template = kubernetes.client.models.io_x_k8s_cluster_infrastructure_v1alpha4_aws_machine_pool_spec_aws_launch_template.io_x_k8s_cluster_infrastructure_v1alpha4_AWSMachinePool_spec_awsLaunchTemplate(
                        ...
                        status = kubernetes.client.models.io_x_k8s_cluster_infrastructure_v1alpha3_aws_machine_pool_status.io_x_k8s_cluster_infrastructure_v1alpha3_AWSMachinePool_status(
                            asg_status = '0', 
                            conditions = [
    ...
    def testIoXK8sClusterInfrastructureV1alpha4AWSMachinePoolList(self):
        """Test IoXK8sClusterInfrastructureV1alpha4AWSMachinePoolList"""
