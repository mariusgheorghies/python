...
from kubernetes.client.models.com_grafana_monitoring_v1alpha1_grafana_agent_spec_api_server import ComGrafanaMonitoringV1alpha1GrafanaAgentSpecApiServer  # noqa: E501
from kubernetes.client.rest import ApiException

class TestComGrafanaMonitoringV1alpha1GrafanaAgentSpecApiServer(unittest.TestCase):
    """ComGrafanaMonitoringV1alpha1GrafanaAgentSpecApiServer unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test ComGrafanaMonitoringV1alpha1GrafanaAgentSpecApiServer
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = kubernetes.client.models.com_grafana_monitoring_v1alpha1_grafana_agent_spec_api_server.ComGrafanaMonitoringV1alpha1GrafanaAgentSpecApiServer()  # noqa: E501
        if include_optional :
            return ComGrafanaMonitoringV1alpha1GrafanaAgentSpecApiServer(
    ...
    def testComGrafanaMonitoringV1alpha1GrafanaAgentSpecApiServer(self):
        """Test ComGrafanaMonitoringV1alpha1GrafanaAgentSpecApiServer"""
