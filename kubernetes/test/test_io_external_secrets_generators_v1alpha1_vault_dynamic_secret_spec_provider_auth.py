...
from kubernetes.client.models.io_external_secrets_generators_v1alpha1_vault_dynamic_secret_spec_provider_auth import IoExternalSecretsGeneratorsV1alpha1VaultDynamicSecretSpecProviderAuth  # noqa: E501
from kubernetes.client.rest import ApiException

class TestIoExternalSecretsGeneratorsV1alpha1VaultDynamicSecretSpecProviderAuth(unittest.TestCase):
    """IoExternalSecretsGeneratorsV1alpha1VaultDynamicSecretSpecProviderAuth unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test IoExternalSecretsGeneratorsV1alpha1VaultDynamicSecretSpecProviderAuth
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = kubernetes.client.models.io_external_secrets_generators_v1alpha1_vault_dynamic_secret_spec_provider_auth.IoExternalSecretsGeneratorsV1alpha1VaultDynamicSecretSpecProviderAuth()  # noqa: E501
        if include_optional :
            return IoExternalSecretsGeneratorsV1alpha1VaultDynamicSecretSpecProviderAuth(
                ...
                kubernetes = kubernetes.client.models.io_external_secrets_generators_v1alpha1_vault_dynamic_secret_spec_provider_auth_kubernetes.io_external_secrets_generators_v1alpha1_VaultDynamicSecret_spec_provider_auth_kubernetes(
                    mount_path = '0', 
                    role = '0', 
                    secret_ref = kubernetes.client.models.io_external_secrets_generators_v1alpha1_vault_dynamic_secret_spec_provider_auth_kubernetes_secret_ref.io_external_secrets_generators_v1alpha1_VaultDynamicSecret_spec_provider_auth_kubernetes_secretRef(
                        key = '0', 
                        name = '0', 
                        namespace = '0', ), 
                    service_account_ref = kubernetes.client.models.io_external_secrets_generators_v1alpha1_vault_dynamic_secret_spec_provider_auth_kubernetes_service_account_ref.io_external_secrets_generators_v1alpha1_VaultDynamicSecret_spec_provider_auth_kubernetes_serviceAccountRef(
                        audiences = [
                            '0'
                            ], 
                        name = '0', 
    ...
    def testIoExternalSecretsGeneratorsV1alpha1VaultDynamicSecretSpecProviderAuth(self):
        """Test IoExternalSecretsGeneratorsV1alpha1VaultDynamicSecretSpecProviderAuth"""
