...
from kubernetes.client.models.io_cert_manager_acme_v1alpha3_challenge_list import IoCertManagerAcmeV1alpha3ChallengeList  # noqa: E501
from kubernetes.client.rest import ApiException

class TestIoCertManagerAcmeV1alpha3ChallengeList(unittest.TestCase):
    """IoCertManagerAcmeV1alpha3ChallengeList unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test IoCertManagerAcmeV1alpha3ChallengeList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = kubernetes.client.models.io_cert_manager_acme_v1alpha3_challenge_list.IoCertManagerAcmeV1alpha3ChallengeList()  # noqa: E501
        if include_optional :
            return IoCertManagerAcmeV1alpha3ChallengeList(
                api_version = '0', 
                items = [
                    kubernetes.client.models.io/cert_manager/acme/v1alpha3/challenge.io.cert-manager.acme.v1alpha3.Challenge(
                        api_version = '0', 
                        kind = '0', 
    ...
    def testIoCertManagerAcmeV1alpha3ChallengeList(self):
        """Test IoCertManagerAcmeV1alpha3ChallengeList"""
