...
from kubernetes.client.models.com_coreos_monitoring_v1_prometheus_spec_apiserver_config_tls_config import ComCoreosMonitoringV1PrometheusSpecApiserverConfigTlsConfig  # noqa: E501
from kubernetes.client.rest import ApiException

class TestComCoreosMonitoringV1PrometheusSpecApiserverConfigTlsConfig(unittest.TestCase):
    """ComCoreosMonitoringV1PrometheusSpecApiserverConfigTlsConfig unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test ComCoreosMonitoringV1PrometheusSpecApiserverConfigTlsConfig
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = kubernetes.client.models.com_coreos_monitoring_v1_prometheus_spec_apiserver_config_tls_config.ComCoreosMonitoringV1PrometheusSpecApiserverConfigTlsConfig()  # noqa: E501
        if include_optional :
            return ComCoreosMonitoringV1PrometheusSpecApiserverConfigTlsConfig(
    ...
    def testComCoreosMonitoringV1PrometheusSpecApiserverConfigTlsConfig(self):
        """Test ComCoreosMonitoringV1PrometheusSpecApiserverConfigTlsConfig"""
