...
from kubernetes.client.models.io_xk8s_cluster_controlplane_v1alpha4_aws_managed_control_plane import IoXK8sClusterControlplaneV1alpha4AWSManagedControlPlane  # noqa: E501
from kubernetes.client.rest import ApiException

class TestIoXK8sClusterControlplaneV1alpha4AWSManagedControlPlane(unittest.TestCase):
    """IoXK8sClusterControlplaneV1alpha4AWSManagedControlPlane unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test IoXK8sClusterControlplaneV1alpha4AWSManagedControlPlane
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = kubernetes.client.models.io_xk8s_cluster_controlplane_v1alpha4_aws_managed_control_plane.IoXK8sClusterControlplaneV1alpha4AWSManagedControlPlane()  # noqa: E501
        if include_optional :
            return IoXK8sClusterControlplaneV1alpha4AWSManagedControlPlane(
                ...
                metadata = kubernetes.client.models.v1/object_meta_v2.v1.ObjectMeta_v2(
                    ...
                    self_link = '0', 
                    uid = '0', ), 
                spec = kubernetes.client.models.io_x_k8s_cluster_controlplane_v1alpha4_aws_managed_control_plane_spec.io_x_k8s_cluster_controlplane_v1alpha4_AWSManagedControlPlane_spec(
                    additional_tags = {
                        'key' : '0'
                        }, 
                    addons = [
                    ...
                    version = 'a', ), 
                status = kubernetes.client.models.io_x_k8s_cluster_controlplane_v1alpha4_aws_managed_control_plane_status.io_x_k8s_cluster_controlplane_v1alpha4_AWSManagedControlPlane_status(
                    addons = [
                        kubernetes.client.models.io_x_k8s_cluster_controlplane_v1alpha3_aws_managed_control_plane_status_addons.io_x_k8s_cluster_controlplane_v1alpha3_AWSManagedControlPlane_status_addons(
                            arn = '0', 
                            created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                            issues = [
                                kubernetes.client.models.io_x_k8s_cluster_controlplane_v1alpha3_aws_managed_control_plane_status_issues.io_x_k8s_cluster_controlplane_v1alpha3_AWSManagedControlPlane_status_issues(
                                    code = '0', 
                                    message = '0', 
                                    resource_ids = [
                                        '0'
                    ...
                    bastion = kubernetes.client.models.io_x_k8s_cluster_controlplane_v1alpha4_aws_managed_control_plane_status_bastion.io_x_k8s_cluster_controlplane_v1alpha4_AWSManagedControlPlane_status_bastion(
                        addresses = [
    ...
    def testIoXK8sClusterControlplaneV1alpha4AWSManagedControlPlane(self):
        """Test IoXK8sClusterControlplaneV1alpha4AWSManagedControlPlane"""
