...
from kubernetes.client.models.io_cert_manager_v1beta1_cluster_issuer_spec_acme_solvers import IoCertManagerV1beta1ClusterIssuerSpecAcmeSolvers  # noqa: E501
from kubernetes.client.rest import ApiException

class TestIoCertManagerV1beta1ClusterIssuerSpecAcmeSolvers(unittest.TestCase):
    """IoCertManagerV1beta1ClusterIssuerSpecAcmeSolvers unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test IoCertManagerV1beta1ClusterIssuerSpecAcmeSolvers
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = kubernetes.client.models.io_cert_manager_v1beta1_cluster_issuer_spec_acme_solvers.IoCertManagerV1beta1ClusterIssuerSpecAcmeSolvers()  # noqa: E501
        if include_optional :
            return IoCertManagerV1beta1ClusterIssuerSpecAcmeSolvers(
    ...
    def testIoCertManagerV1beta1ClusterIssuerSpecAcmeSolvers(self):
        """Test IoCertManagerV1beta1ClusterIssuerSpecAcmeSolvers"""
