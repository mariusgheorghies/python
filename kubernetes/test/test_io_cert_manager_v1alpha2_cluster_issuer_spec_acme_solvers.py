...
from kubernetes.client.models.io_cert_manager_v1alpha2_cluster_issuer_spec_acme_solvers import IoCertManagerV1alpha2ClusterIssuerSpecAcmeSolvers  # noqa: E501
from kubernetes.client.rest import ApiException

class TestIoCertManagerV1alpha2ClusterIssuerSpecAcmeSolvers(unittest.TestCase):
    """IoCertManagerV1alpha2ClusterIssuerSpecAcmeSolvers unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test IoCertManagerV1alpha2ClusterIssuerSpecAcmeSolvers
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = kubernetes.client.models.io_cert_manager_v1alpha2_cluster_issuer_spec_acme_solvers.IoCertManagerV1alpha2ClusterIssuerSpecAcmeSolvers()  # noqa: E501
        if include_optional :
            return IoCertManagerV1alpha2ClusterIssuerSpecAcmeSolvers(
    ...
    def testIoCertManagerV1alpha2ClusterIssuerSpecAcmeSolvers(self):
        """Test IoCertManagerV1alpha2ClusterIssuerSpecAcmeSolvers"""
