...
from kubernetes.client.models.io_xk8s_cluster_controlplane_v1alpha4_kubeadm_control_plane_template_spec_template import IoXK8sClusterControlplaneV1alpha4KubeadmControlPlaneTemplateSpecTemplate  # noqa: E501
from kubernetes.client.rest import ApiException

class TestIoXK8sClusterControlplaneV1alpha4KubeadmControlPlaneTemplateSpecTemplate(unittest.TestCase):
    """IoXK8sClusterControlplaneV1alpha4KubeadmControlPlaneTemplateSpecTemplate unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test IoXK8sClusterControlplaneV1alpha4KubeadmControlPlaneTemplateSpecTemplate
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = kubernetes.client.models.io_xk8s_cluster_controlplane_v1alpha4_kubeadm_control_plane_template_spec_template.IoXK8sClusterControlplaneV1alpha4KubeadmControlPlaneTemplateSpecTemplate()  # noqa: E501
        if include_optional :
            return IoXK8sClusterControlplaneV1alpha4KubeadmControlPlaneTemplateSpecTemplate(
    ...
    def testIoXK8sClusterControlplaneV1alpha4KubeadmControlPlaneTemplateSpecTemplate(self):
        """Test IoXK8sClusterControlplaneV1alpha4KubeadmControlPlaneTemplateSpecTemplate"""
