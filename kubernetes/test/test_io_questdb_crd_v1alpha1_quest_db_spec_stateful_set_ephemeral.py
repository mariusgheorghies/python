...
from kubernetes.client.models.io_questdb_crd_v1alpha1_quest_db_spec_stateful_set_ephemeral import IoQuestdbCrdV1alpha1QuestDBSpecStatefulSetEphemeral  # noqa: E501
from kubernetes.client.rest import ApiException

class TestIoQuestdbCrdV1alpha1QuestDBSpecStatefulSetEphemeral(unittest.TestCase):
    """IoQuestdbCrdV1alpha1QuestDBSpecStatefulSetEphemeral unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test IoQuestdbCrdV1alpha1QuestDBSpecStatefulSetEphemeral
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = kubernetes.client.models.io_questdb_crd_v1alpha1_quest_db_spec_stateful_set_ephemeral.IoQuestdbCrdV1alpha1QuestDBSpecStatefulSetEphemeral()  # noqa: E501
        if include_optional :
            return IoQuestdbCrdV1alpha1QuestDBSpecStatefulSetEphemeral(
    ...
    def testIoQuestdbCrdV1alpha1QuestDBSpecStatefulSetEphemeral(self):
        """Test IoQuestdbCrdV1alpha1QuestDBSpecStatefulSetEphemeral"""
