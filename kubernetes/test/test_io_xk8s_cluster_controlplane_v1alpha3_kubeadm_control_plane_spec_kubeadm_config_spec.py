...
from kubernetes.client.models.io_xk8s_cluster_controlplane_v1alpha3_kubeadm_control_plane_spec_kubeadm_config_spec import IoXK8sClusterControlplaneV1alpha3KubeadmControlPlaneSpecKubeadmConfigSpec  # noqa: E501
from kubernetes.client.rest import ApiException

class TestIoXK8sClusterControlplaneV1alpha3KubeadmControlPlaneSpecKubeadmConfigSpec(unittest.TestCase):
    """IoXK8sClusterControlplaneV1alpha3KubeadmControlPlaneSpecKubeadmConfigSpec unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test IoXK8sClusterControlplaneV1alpha3KubeadmControlPlaneSpecKubeadmConfigSpec
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = kubernetes.client.models.io_xk8s_cluster_controlplane_v1alpha3_kubeadm_control_plane_spec_kubeadm_config_spec.IoXK8sClusterControlplaneV1alpha3KubeadmControlPlaneSpecKubeadmConfigSpec()  # noqa: E501
        if include_optional :
            return IoXK8sClusterControlplaneV1alpha3KubeadmControlPlaneSpecKubeadmConfigSpec(
    ...
    def testIoXK8sClusterControlplaneV1alpha3KubeadmControlPlaneSpecKubeadmConfigSpec(self):
        """Test IoXK8sClusterControlplaneV1alpha3KubeadmControlPlaneSpecKubeadmConfigSpec"""
