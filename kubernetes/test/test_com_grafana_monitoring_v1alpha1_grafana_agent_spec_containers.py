...
from kubernetes.client.models.com_grafana_monitoring_v1alpha1_grafana_agent_spec_containers import ComGrafanaMonitoringV1alpha1GrafanaAgentSpecContainers  # noqa: E501
from kubernetes.client.rest import ApiException

class TestComGrafanaMonitoringV1alpha1GrafanaAgentSpecContainers(unittest.TestCase):
    """ComGrafanaMonitoringV1alpha1GrafanaAgentSpecContainers unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test ComGrafanaMonitoringV1alpha1GrafanaAgentSpecContainers
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = kubernetes.client.models.com_grafana_monitoring_v1alpha1_grafana_agent_spec_containers.ComGrafanaMonitoringV1alpha1GrafanaAgentSpecContainers()  # noqa: E501
        if include_optional :
            return ComGrafanaMonitoringV1alpha1GrafanaAgentSpecContainers(
                args = [
                    '0'
                    ], 
                command = [
    ...
    def testComGrafanaMonitoringV1alpha1GrafanaAgentSpecContainers(self):
        """Test ComGrafanaMonitoringV1alpha1GrafanaAgentSpecContainers"""
