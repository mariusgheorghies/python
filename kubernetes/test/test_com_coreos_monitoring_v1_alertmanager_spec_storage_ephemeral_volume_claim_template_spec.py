...
from kubernetes.client.models.com_coreos_monitoring_v1_alertmanager_spec_storage_ephemeral_volume_claim_template_spec import ComCoreosMonitoringV1AlertmanagerSpecStorageEphemeralVolumeClaimTemplateSpec  # noqa: E501
from kubernetes.client.rest import ApiException

class TestComCoreosMonitoringV1AlertmanagerSpecStorageEphemeralVolumeClaimTemplateSpec(unittest.TestCase):
    """ComCoreosMonitoringV1AlertmanagerSpecStorageEphemeralVolumeClaimTemplateSpec unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test ComCoreosMonitoringV1AlertmanagerSpecStorageEphemeralVolumeClaimTemplateSpec
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = kubernetes.client.models.com_coreos_monitoring_v1_alertmanager_spec_storage_ephemeral_volume_claim_template_spec.ComCoreosMonitoringV1AlertmanagerSpecStorageEphemeralVolumeClaimTemplateSpec()  # noqa: E501
        if include_optional :
            return ComCoreosMonitoringV1AlertmanagerSpecStorageEphemeralVolumeClaimTemplateSpec(
                access_modes = [
                    '0'
                    ], 
    ...
    def testComCoreosMonitoringV1AlertmanagerSpecStorageEphemeralVolumeClaimTemplateSpec(self):
        """Test ComCoreosMonitoringV1AlertmanagerSpecStorageEphemeralVolumeClaimTemplateSpec"""
