...
from kubernetes.client.models.io_external_secrets_generators_v1alpha1_acr_access_token_spec_auth import IoExternalSecretsGeneratorsV1alpha1ACRAccessTokenSpecAuth  # noqa: E501
from kubernetes.client.rest import ApiException

class TestIoExternalSecretsGeneratorsV1alpha1ACRAccessTokenSpecAuth(unittest.TestCase):
    """IoExternalSecretsGeneratorsV1alpha1ACRAccessTokenSpecAuth unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test IoExternalSecretsGeneratorsV1alpha1ACRAccessTokenSpecAuth
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = kubernetes.client.models.io_external_secrets_generators_v1alpha1_acr_access_token_spec_auth.IoExternalSecretsGeneratorsV1alpha1ACRAccessTokenSpecAuth()  # noqa: E501
        if include_optional :
            return IoExternalSecretsGeneratorsV1alpha1ACRAccessTokenSpecAuth(
    ...
    def testIoExternalSecretsGeneratorsV1alpha1ACRAccessTokenSpecAuth(self):
        """Test IoExternalSecretsGeneratorsV1alpha1ACRAccessTokenSpecAuth"""
