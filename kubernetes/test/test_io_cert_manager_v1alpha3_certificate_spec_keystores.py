...
from kubernetes.client.models.io_cert_manager_v1alpha3_certificate_spec_keystores import IoCertManagerV1alpha3CertificateSpecKeystores  # noqa: E501
from kubernetes.client.rest import ApiException

class TestIoCertManagerV1alpha3CertificateSpecKeystores(unittest.TestCase):
    """IoCertManagerV1alpha3CertificateSpecKeystores unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test IoCertManagerV1alpha3CertificateSpecKeystores
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = kubernetes.client.models.io_cert_manager_v1alpha3_certificate_spec_keystores.IoCertManagerV1alpha3CertificateSpecKeystores()  # noqa: E501
        if include_optional :
            return IoCertManagerV1alpha3CertificateSpecKeystores(
    ...
    def testIoCertManagerV1alpha3CertificateSpecKeystores(self):
        """Test IoCertManagerV1alpha3CertificateSpecKeystores"""
