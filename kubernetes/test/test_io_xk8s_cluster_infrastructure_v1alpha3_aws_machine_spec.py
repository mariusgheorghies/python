...
from kubernetes.client.models.io_xk8s_cluster_infrastructure_v1alpha3_aws_machine_spec import IoXK8sClusterInfrastructureV1alpha3AWSMachineSpec  # noqa: E501
from kubernetes.client.rest import ApiException

class TestIoXK8sClusterInfrastructureV1alpha3AWSMachineSpec(unittest.TestCase):
    """IoXK8sClusterInfrastructureV1alpha3AWSMachineSpec unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test IoXK8sClusterInfrastructureV1alpha3AWSMachineSpec
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = kubernetes.client.models.io_xk8s_cluster_infrastructure_v1alpha3_aws_machine_spec.IoXK8sClusterInfrastructureV1alpha3AWSMachineSpec()  # noqa: E501
        if include_optional :
            return IoXK8sClusterInfrastructureV1alpha3AWSMachineSpec(
    ...
    def testIoXK8sClusterInfrastructureV1alpha3AWSMachineSpec(self):
        """Test IoXK8sClusterInfrastructureV1alpha3AWSMachineSpec"""
