...
from kubernetes.client.models.com_grafana_monitoring_v1alpha1_pod_logs_spec_pipeline_stages import ComGrafanaMonitoringV1alpha1PodLogsSpecPipelineStages  # noqa: E501
from kubernetes.client.rest import ApiException

class TestComGrafanaMonitoringV1alpha1PodLogsSpecPipelineStages(unittest.TestCase):
    """ComGrafanaMonitoringV1alpha1PodLogsSpecPipelineStages unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test ComGrafanaMonitoringV1alpha1PodLogsSpecPipelineStages
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = kubernetes.client.models.com_grafana_monitoring_v1alpha1_pod_logs_spec_pipeline_stages.ComGrafanaMonitoringV1alpha1PodLogsSpecPipelineStages()  # noqa: E501
        if include_optional :
            return ComGrafanaMonitoringV1alpha1PodLogsSpecPipelineStages(
    ...
    def testComGrafanaMonitoringV1alpha1PodLogsSpecPipelineStages(self):
        """Test ComGrafanaMonitoringV1alpha1PodLogsSpecPipelineStages"""
