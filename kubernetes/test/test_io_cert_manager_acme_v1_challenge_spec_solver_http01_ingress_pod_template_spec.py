...
from kubernetes.client.models.io_cert_manager_acme_v1_challenge_spec_solver_http01_ingress_pod_template_spec import IoCertManagerAcmeV1ChallengeSpecSolverHttp01IngressPodTemplateSpec  # noqa: E501
from kubernetes.client.rest import ApiException

class TestIoCertManagerAcmeV1ChallengeSpecSolverHttp01IngressPodTemplateSpec(unittest.TestCase):
    """IoCertManagerAcmeV1ChallengeSpecSolverHttp01IngressPodTemplateSpec unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test IoCertManagerAcmeV1ChallengeSpecSolverHttp01IngressPodTemplateSpec
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = kubernetes.client.models.io_cert_manager_acme_v1_challenge_spec_solver_http01_ingress_pod_template_spec.IoCertManagerAcmeV1ChallengeSpecSolverHttp01IngressPodTemplateSpec()  # noqa: E501
        if include_optional :
    ...
    def testIoCertManagerAcmeV1ChallengeSpecSolverHttp01IngressPodTemplateSpec(self):
        """Test IoCertManagerAcmeV1ChallengeSpecSolverHttp01IngressPodTemplateSpec"""
