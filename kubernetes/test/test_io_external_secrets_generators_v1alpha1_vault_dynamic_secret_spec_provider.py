...
from kubernetes.client.models.io_external_secrets_generators_v1alpha1_vault_dynamic_secret_spec_provider import IoExternalSecretsGeneratorsV1alpha1VaultDynamicSecretSpecProvider  # noqa: E501
from kubernetes.client.rest import ApiException

class TestIoExternalSecretsGeneratorsV1alpha1VaultDynamicSecretSpecProvider(unittest.TestCase):
    """IoExternalSecretsGeneratorsV1alpha1VaultDynamicSecretSpecProvider unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test IoExternalSecretsGeneratorsV1alpha1VaultDynamicSecretSpecProvider
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = kubernetes.client.models.io_external_secrets_generators_v1alpha1_vault_dynamic_secret_spec_provider.IoExternalSecretsGeneratorsV1alpha1VaultDynamicSecretSpecProvider()  # noqa: E501
        if include_optional :
            return IoExternalSecretsGeneratorsV1alpha1VaultDynamicSecretSpecProvider(
    ...
    def testIoExternalSecretsGeneratorsV1alpha1VaultDynamicSecretSpecProvider(self):
        """Test IoExternalSecretsGeneratorsV1alpha1VaultDynamicSecretSpecProvider"""
