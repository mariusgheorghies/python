...
from kubernetes.client.models.io_xk8s_cluster_controlplane_v1alpha4_kubeadm_control_plane_template_list import IoXK8sClusterControlplaneV1alpha4KubeadmControlPlaneTemplateList  # noqa: E501
from kubernetes.client.rest import ApiException

class TestIoXK8sClusterControlplaneV1alpha4KubeadmControlPlaneTemplateList(unittest.TestCase):
    """IoXK8sClusterControlplaneV1alpha4KubeadmControlPlaneTemplateList unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test IoXK8sClusterControlplaneV1alpha4KubeadmControlPlaneTemplateList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = kubernetes.client.models.io_xk8s_cluster_controlplane_v1alpha4_kubeadm_control_plane_template_list.IoXK8sClusterControlplaneV1alpha4KubeadmControlPlaneTemplateList()  # noqa: E501
        if include_optional :
            return IoXK8sClusterControlplaneV1alpha4KubeadmControlPlaneTemplateList(
                api_version = '0', 
                items = [
                    kubernetes.client.models.io/x_k8s/cluster/controlplane/v1alpha4/kubeadm_control_plane_template.io.x-k8s.cluster.controlplane.v1alpha4.KubeadmControlPlaneTemplate(
                        api_version = '0', 
                        kind = '0', 
                        metadata = kubernetes.client.models.v1/object_meta_v2.v1.ObjectMeta_v2(
                            ...
                            self_link = '0', 
                            uid = '0', ), 
                        spec = kubernetes.client.models.io_x_k8s_cluster_controlplane_v1alpha4_kubeadm_control_plane_template_spec.io_x_k8s_cluster_controlplane_v1alpha4_KubeadmControlPlaneTemplate_spec(
                            template = kubernetes.client.models.io_x_k8s_cluster_controlplane_v1alpha4_kubeadm_control_plane_template_spec_template.io_x_k8s_cluster_controlplane_v1alpha4_KubeadmControlPlaneTemplate_spec_template(
                                spec = kubernetes.client.models.io_x_k8s_cluster_controlplane_v1alpha4_kubeadm_control_plane_spec.io_x_k8s_cluster_controlplane_v1alpha4_KubeadmControlPlane_spec(
    ...
    def testIoXK8sClusterControlplaneV1alpha4KubeadmControlPlaneTemplateList(self):
        """Test IoXK8sClusterControlplaneV1alpha4KubeadmControlPlaneTemplateList"""
