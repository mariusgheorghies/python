    ...
    def make_instance(self, include_optional):
        ...
        if include_optional :
            return ComCoreosMonitoringV1ThanosRulerSpec(
                ...
                alert_query_url = '0', 
                alert_relabel_config_file = '0', 
                alert_relabel_configs = kubernetes.client.models.com_coreos_monitoring_v1_thanos_ruler_spec_alert_relabel_configs.com_coreos_monitoring_v1_ThanosRuler_spec_alertRelabelConfigs(
                    key = '0', 
                    name = '0', 
                    optional = True, ), 
