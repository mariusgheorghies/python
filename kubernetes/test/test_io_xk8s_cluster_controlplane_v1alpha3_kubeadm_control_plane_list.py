...
from kubernetes.client.models.io_xk8s_cluster_controlplane_v1alpha3_kubeadm_control_plane_list import IoXK8sClusterControlplaneV1alpha3KubeadmControlPlaneList  # noqa: E501
from kubernetes.client.rest import ApiException

class TestIoXK8sClusterControlplaneV1alpha3KubeadmControlPlaneList(unittest.TestCase):
    """IoXK8sClusterControlplaneV1alpha3KubeadmControlPlaneList unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test IoXK8sClusterControlplaneV1alpha3KubeadmControlPlaneList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = kubernetes.client.models.io_xk8s_cluster_controlplane_v1alpha3_kubeadm_control_plane_list.IoXK8sClusterControlplaneV1alpha3KubeadmControlPlaneList()  # noqa: E501
        if include_optional :
            return IoXK8sClusterControlplaneV1alpha3KubeadmControlPlaneList(
                api_version = '0', 
                items = [
                    kubernetes.client.models.io/x_k8s/cluster/controlplane/v1alpha3/kubeadm_control_plane.io.x-k8s.cluster.controlplane.v1alpha3.KubeadmControlPlane(
                        api_version = '0', 
                        kind = '0', 
                        metadata = kubernetes.client.models.v1/object_meta_v2.v1.ObjectMeta_v2(
                            ...
                            self_link = '0', 
                            uid = '0', ), 
                        spec = kubernetes.client.models.io_x_k8s_cluster_controlplane_v1alpha3_kubeadm_control_plane_spec.io_x_k8s_cluster_controlplane_v1alpha3_KubeadmControlPlane_spec(
                            infrastructure_template = kubernetes.client.models.io_x_k8s_cluster_controlplane_v1alpha3_kubeadm_control_plane_spec_infrastructure_template.io_x_k8s_cluster_controlplane_v1alpha3_KubeadmControlPlane_spec_infrastructureTemplate(
                                api_version = '0', 
                                field_path = '0', 
                                kind = '0', 
                                name = '0', 
                                ...
                                resource_version = '0', 
                                uid = '0', ), 
                            kubeadm_config_spec = kubernetes.client.models.io_x_k8s_cluster_controlplane_v1alpha3_kubeadm_control_plane_spec_kubeadm_config_spec.io_x_k8s_cluster_controlplane_v1alpha3_KubeadmControlPlane_spec_kubeadmConfigSpec(
                                cluster_configuration = kubernetes.client.models.io_x_k8s_cluster_bootstrap_v1alpha3_kubeadm_config_spec_cluster_configuration.io_x_k8s_cluster_bootstrap_v1alpha3_KubeadmConfig_spec_clusterConfiguration(
                                ...
                                format = 'cloud-config', 
                                init_configuration = kubernetes.client.models.io_x_k8s_cluster_bootstrap_v1alpha3_kubeadm_config_spec_init_configuration.io_x_k8s_cluster_bootstrap_v1alpha3_KubeadmConfig_spec_initConfiguration(
                                    api_version = '0', 
                                    bootstrap_tokens = [
                                    ...
                                    kind = '0', 
                                    local_api_endpoint = kubernetes.client.models.io_x_k8s_cluster_bootstrap_v1alpha3_kubeadm_config_spec_init_configuration_local_api_endpoint.io_x_k8s_cluster_bootstrap_v1alpha3_KubeadmConfig_spec_initConfiguration_localAPIEndpoint(
                                        advertise_address = '0', 
                                        bind_port = 56, ), 
                                ...
                                join_configuration = kubernetes.client.models.io_x_k8s_cluster_bootstrap_v1alpha3_kubeadm_config_spec_join_configuration.io_x_k8s_cluster_bootstrap_v1alpha3_KubeadmConfig_spec_joinConfiguration(
                                    api_version = '0', 
                                    ca_cert_path = '0', 
                            ...
                            rollout_strategy = kubernetes.client.models.io_x_k8s_cluster_controlplane_v1alpha3_kubeadm_control_plane_spec_rollout_strategy.io_x_k8s_cluster_controlplane_v1alpha3_KubeadmControlPlane_spec_rolloutStrategy(
                                ...
                                type = '0', ), 
                            upgrade_after = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                            version = '0', ), 
                        status = kubernetes.client.models.io_x_k8s_cluster_controlplane_v1alpha3_kubeadm_control_plane_status.io_x_k8s_cluster_controlplane_v1alpha3_KubeadmControlPlane_status(
                            conditions = [
    ...
    def testIoXK8sClusterControlplaneV1alpha3KubeadmControlPlaneList(self):
        """Test IoXK8sClusterControlplaneV1alpha3KubeadmControlPlaneList"""
