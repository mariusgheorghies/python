...
from kubernetes.client.models.com_coreos_monitoring_v1alpha1_alertmanager_config_spec_pagerduty_configs import ComCoreosMonitoringV1alpha1AlertmanagerConfigSpecPagerdutyConfigs  # noqa: E501
from kubernetes.client.rest import ApiException

class TestComCoreosMonitoringV1alpha1AlertmanagerConfigSpecPagerdutyConfigs(unittest.TestCase):
    """ComCoreosMonitoringV1alpha1AlertmanagerConfigSpecPagerdutyConfigs unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test ComCoreosMonitoringV1alpha1AlertmanagerConfigSpecPagerdutyConfigs
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = kubernetes.client.models.com_coreos_monitoring_v1alpha1_alertmanager_config_spec_pagerduty_configs.ComCoreosMonitoringV1alpha1AlertmanagerConfigSpecPagerdutyConfigs()  # noqa: E501
        if include_optional :
            return ComCoreosMonitoringV1alpha1AlertmanagerConfigSpecPagerdutyConfigs(
                _class = '0', 
                kubernetes.client = '0', 
    ...
    def testComCoreosMonitoringV1alpha1AlertmanagerConfigSpecPagerdutyConfigs(self):
        """Test ComCoreosMonitoringV1alpha1AlertmanagerConfigSpecPagerdutyConfigs"""
