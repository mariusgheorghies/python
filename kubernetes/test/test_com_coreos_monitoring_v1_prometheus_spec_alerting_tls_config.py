...
from kubernetes.client.models.com_coreos_monitoring_v1_prometheus_spec_alerting_tls_config import ComCoreosMonitoringV1PrometheusSpecAlertingTlsConfig  # noqa: E501
from kubernetes.client.rest import ApiException

class TestComCoreosMonitoringV1PrometheusSpecAlertingTlsConfig(unittest.TestCase):
    """ComCoreosMonitoringV1PrometheusSpecAlertingTlsConfig unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test ComCoreosMonitoringV1PrometheusSpecAlertingTlsConfig
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = kubernetes.client.models.com_coreos_monitoring_v1_prometheus_spec_alerting_tls_config.ComCoreosMonitoringV1PrometheusSpecAlertingTlsConfig()  # noqa: E501
        if include_optional :
            return ComCoreosMonitoringV1PrometheusSpecAlertingTlsConfig(
    ...
    def testComCoreosMonitoringV1PrometheusSpecAlertingTlsConfig(self):
        """Test ComCoreosMonitoringV1PrometheusSpecAlertingTlsConfig"""
