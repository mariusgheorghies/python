...
from kubernetes.client.models.io_xk8s_cluster_infrastructure_v1alpha3_aws_managed_machine_pool_list import IoXK8sClusterInfrastructureV1alpha3AWSManagedMachinePoolList  # noqa: E501
from kubernetes.client.rest import ApiException

class TestIoXK8sClusterInfrastructureV1alpha3AWSManagedMachinePoolList(unittest.TestCase):
    """IoXK8sClusterInfrastructureV1alpha3AWSManagedMachinePoolList unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test IoXK8sClusterInfrastructureV1alpha3AWSManagedMachinePoolList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = kubernetes.client.models.io_xk8s_cluster_infrastructure_v1alpha3_aws_managed_machine_pool_list.IoXK8sClusterInfrastructureV1alpha3AWSManagedMachinePoolList()  # noqa: E501
        if include_optional :
            return IoXK8sClusterInfrastructureV1alpha3AWSManagedMachinePoolList(
                api_version = '0', 
                items = [
                    kubernetes.client.models.io/x_k8s/cluster/infrastructure/v1alpha3/aws_managed_machine_pool.io.x-k8s.cluster.infrastructure.v1alpha3.AWSManagedMachinePool(
                        api_version = '0', 
                        kind = '0', 
    ...
    def testIoXK8sClusterInfrastructureV1alpha3AWSManagedMachinePoolList(self):
        """Test IoXK8sClusterInfrastructureV1alpha3AWSManagedMachinePoolList"""
