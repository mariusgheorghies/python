...
from kubernetes.client.models.io_xk8s_cluster_v1alpha4_cluster_class_spec_workers_machine_deployments import IoXK8sClusterV1alpha4ClusterClassSpecWorkersMachineDeployments  # noqa: E501
from kubernetes.client.rest import ApiException

class TestIoXK8sClusterV1alpha4ClusterClassSpecWorkersMachineDeployments(unittest.TestCase):
    """IoXK8sClusterV1alpha4ClusterClassSpecWorkersMachineDeployments unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test IoXK8sClusterV1alpha4ClusterClassSpecWorkersMachineDeployments
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = kubernetes.client.models.io_xk8s_cluster_v1alpha4_cluster_class_spec_workers_machine_deployments.IoXK8sClusterV1alpha4ClusterClassSpecWorkersMachineDeployments()  # noqa: E501
        if include_optional :
            return IoXK8sClusterV1alpha4ClusterClassSpecWorkersMachineDeployments(
                _class = '0', 
    ...
    def testIoXK8sClusterV1alpha4ClusterClassSpecWorkersMachineDeployments(self):
        """Test IoXK8sClusterV1alpha4ClusterClassSpecWorkersMachineDeployments"""
