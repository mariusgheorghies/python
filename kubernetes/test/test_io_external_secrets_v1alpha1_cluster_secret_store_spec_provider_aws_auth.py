...
from kubernetes.client.models.io_external_secrets_v1alpha1_cluster_secret_store_spec_provider_aws_auth import IoExternalSecretsV1alpha1ClusterSecretStoreSpecProviderAwsAuth  # noqa: E501
from kubernetes.client.rest import ApiException

class TestIoExternalSecretsV1alpha1ClusterSecretStoreSpecProviderAwsAuth(unittest.TestCase):
    """IoExternalSecretsV1alpha1ClusterSecretStoreSpecProviderAwsAuth unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test IoExternalSecretsV1alpha1ClusterSecretStoreSpecProviderAwsAuth
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = kubernetes.client.models.io_external_secrets_v1alpha1_cluster_secret_store_spec_provider_aws_auth.IoExternalSecretsV1alpha1ClusterSecretStoreSpecProviderAwsAuth()  # noqa: E501
        if include_optional :
            return IoExternalSecretsV1alpha1ClusterSecretStoreSpecProviderAwsAuth(
    ...
    def testIoExternalSecretsV1alpha1ClusterSecretStoreSpecProviderAwsAuth(self):
        """Test IoExternalSecretsV1alpha1ClusterSecretStoreSpecProviderAwsAuth"""
