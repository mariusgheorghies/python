...
from kubernetes.client.models.io_xk8s_cluster_infrastructure_v1alpha4_aws_machine_template_spec_template import IoXK8sClusterInfrastructureV1alpha4AWSMachineTemplateSpecTemplate  # noqa: E501
from kubernetes.client.rest import ApiException

class TestIoXK8sClusterInfrastructureV1alpha4AWSMachineTemplateSpecTemplate(unittest.TestCase):
    """IoXK8sClusterInfrastructureV1alpha4AWSMachineTemplateSpecTemplate unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test IoXK8sClusterInfrastructureV1alpha4AWSMachineTemplateSpecTemplate
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = kubernetes.client.models.io_xk8s_cluster_infrastructure_v1alpha4_aws_machine_template_spec_template.IoXK8sClusterInfrastructureV1alpha4AWSMachineTemplateSpecTemplate()  # noqa: E501
        if include_optional :
            return IoXK8sClusterInfrastructureV1alpha4AWSMachineTemplateSpecTemplate(
    ...
    def testIoXK8sClusterInfrastructureV1alpha4AWSMachineTemplateSpecTemplate(self):
        """Test IoXK8sClusterInfrastructureV1alpha4AWSMachineTemplateSpecTemplate"""
