...
from kubernetes.client.models.io_xk8s_cluster_controlplane_v1alpha4_aws_managed_control_plane_status_bastion import IoXK8sClusterControlplaneV1alpha4AWSManagedControlPlaneStatusBastion  # noqa: E501
from kubernetes.client.rest import ApiException

class TestIoXK8sClusterControlplaneV1alpha4AWSManagedControlPlaneStatusBastion(unittest.TestCase):
    """IoXK8sClusterControlplaneV1alpha4AWSManagedControlPlaneStatusBastion unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test IoXK8sClusterControlplaneV1alpha4AWSManagedControlPlaneStatusBastion
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = kubernetes.client.models.io_xk8s_cluster_controlplane_v1alpha4_aws_managed_control_plane_status_bastion.IoXK8sClusterControlplaneV1alpha4AWSManagedControlPlaneStatusBastion()  # noqa: E501
        if include_optional :
            return IoXK8sClusterControlplaneV1alpha4AWSManagedControlPlaneStatusBastion(
                addresses = [
    ...
    def testIoXK8sClusterControlplaneV1alpha4AWSManagedControlPlaneStatusBastion(self):
        """Test IoXK8sClusterControlplaneV1alpha4AWSManagedControlPlaneStatusBastion"""
