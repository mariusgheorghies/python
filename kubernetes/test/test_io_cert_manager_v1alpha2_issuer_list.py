...
from kubernetes.client.models.io_cert_manager_v1alpha2_issuer_list import IoCertManagerV1alpha2IssuerList  # noqa: E501
from kubernetes.client.rest import ApiException

class TestIoCertManagerV1alpha2IssuerList(unittest.TestCase):
    """IoCertManagerV1alpha2IssuerList unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test IoCertManagerV1alpha2IssuerList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = kubernetes.client.models.io_cert_manager_v1alpha2_issuer_list.IoCertManagerV1alpha2IssuerList()  # noqa: E501
        if include_optional :
            return IoCertManagerV1alpha2IssuerList(
                api_version = '0', 
                items = [
                    kubernetes.client.models.io/cert_manager/v1alpha2/issuer.io.cert-manager.v1alpha2.Issuer(
                        api_version = '0', 
                        kind = '0', 
    ...
    def testIoCertManagerV1alpha2IssuerList(self):
        """Test IoCertManagerV1alpha2IssuerList"""
