...
from kubernetes.client.models.io_questdb_crd_v1alpha1_quest_db_spec import IoQuestdbCrdV1alpha1QuestDBSpec  # noqa: E501
from kubernetes.client.rest import ApiException

class TestIoQuestdbCrdV1alpha1QuestDBSpec(unittest.TestCase):
    """IoQuestdbCrdV1alpha1QuestDBSpec unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test IoQuestdbCrdV1alpha1QuestDBSpec
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = kubernetes.client.models.io_questdb_crd_v1alpha1_quest_db_spec.IoQuestdbCrdV1alpha1QuestDBSpec()  # noqa: E501
        if include_optional :
            return IoQuestdbCrdV1alpha1QuestDBSpec(
                allowed_cidr = [
                    '0'
                    ], 
    ...
    def testIoQuestdbCrdV1alpha1QuestDBSpec(self):
        """Test IoQuestdbCrdV1alpha1QuestDBSpec"""
