...
from kubernetes.client.models.io_argoproj_v1alpha1_application_set_spec_matrix_scm_provider import IoArgoprojV1alpha1ApplicationSetSpecMatrixScmProvider  # noqa: E501
from kubernetes.client.rest import ApiException

class TestIoArgoprojV1alpha1ApplicationSetSpecMatrixScmProvider(unittest.TestCase):
    """IoArgoprojV1alpha1ApplicationSetSpecMatrixScmProvider unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test IoArgoprojV1alpha1ApplicationSetSpecMatrixScmProvider
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = kubernetes.client.models.io_argoproj_v1alpha1_application_set_spec_matrix_scm_provider.IoArgoprojV1alpha1ApplicationSetSpecMatrixScmProvider()  # noqa: E501
        if include_optional :
            return IoArgoprojV1alpha1ApplicationSetSpecMatrixScmProvider(
    ...
    def testIoArgoprojV1alpha1ApplicationSetSpecMatrixScmProvider(self):
        """Test IoArgoprojV1alpha1ApplicationSetSpecMatrixScmProvider"""
