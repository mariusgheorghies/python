...
from kubernetes.client.models.io_xk8s_cluster_controlplane_v1alpha4_kubeadm_control_plane_list import IoXK8sClusterControlplaneV1alpha4KubeadmControlPlaneList  # noqa: E501
from kubernetes.client.rest import ApiException

class TestIoXK8sClusterControlplaneV1alpha4KubeadmControlPlaneList(unittest.TestCase):
    """IoXK8sClusterControlplaneV1alpha4KubeadmControlPlaneList unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test IoXK8sClusterControlplaneV1alpha4KubeadmControlPlaneList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = kubernetes.client.models.io_xk8s_cluster_controlplane_v1alpha4_kubeadm_control_plane_list.IoXK8sClusterControlplaneV1alpha4KubeadmControlPlaneList()  # noqa: E501
        if include_optional :
            return IoXK8sClusterControlplaneV1alpha4KubeadmControlPlaneList(
                api_version = '0', 
                items = [
                    kubernetes.client.models.io/x_k8s/cluster/controlplane/v1alpha4/kubeadm_control_plane.io.x-k8s.cluster.controlplane.v1alpha4.KubeadmControlPlane(
                        api_version = '0', 
                        kind = '0', 
                        ...
                        spec = kubernetes.client.models.io_x_k8s_cluster_controlplane_v1alpha4_kubeadm_control_plane_spec.io_x_k8s_cluster_controlplane_v1alpha4_KubeadmControlPlane_spec(
                            ...
                            rollout_strategy = kubernetes.client.models.io_x_k8s_cluster_controlplane_v1alpha3_kubeadm_control_plane_spec_rollout_strategy.io_x_k8s_cluster_controlplane_v1alpha3_KubeadmControlPlane_spec_rolloutStrategy(
                                ...
                                type = '0', ), 
                            version = '0', ), 
                        status = kubernetes.client.models.io_x_k8s_cluster_controlplane_v1alpha4_kubeadm_control_plane_status.io_x_k8s_cluster_controlplane_v1alpha4_KubeadmControlPlane_status(
                            conditions = [
    ...
    def testIoXK8sClusterControlplaneV1alpha4KubeadmControlPlaneList(self):
        """Test IoXK8sClusterControlplaneV1alpha4KubeadmControlPlaneList"""
