...
from kubernetes.client.models.io_xk8s_cluster_infrastructure_v1alpha3_aws_cluster_status import IoXK8sClusterInfrastructureV1alpha3AWSClusterStatus  # noqa: E501
from kubernetes.client.rest import ApiException

class TestIoXK8sClusterInfrastructureV1alpha3AWSClusterStatus(unittest.TestCase):
    """IoXK8sClusterInfrastructureV1alpha3AWSClusterStatus unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test IoXK8sClusterInfrastructureV1alpha3AWSClusterStatus
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = kubernetes.client.models.io_xk8s_cluster_infrastructure_v1alpha3_aws_cluster_status.IoXK8sClusterInfrastructureV1alpha3AWSClusterStatus()  # noqa: E501
        if include_optional :
            return IoXK8sClusterInfrastructureV1alpha3AWSClusterStatus(
                bastion = kubernetes.client.models.io_x_k8s_cluster_infrastructure_v1alpha3_aws_cluster_status_bastion.io_x_k8s_cluster_infrastructure_v1alpha3_AWSCluster_status_bastion(
                    addresses = [
    ...
    def testIoXK8sClusterInfrastructureV1alpha3AWSClusterStatus(self):
        """Test IoXK8sClusterInfrastructureV1alpha3AWSClusterStatus"""
