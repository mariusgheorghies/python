...
from kubernetes.client.models.io_questdb_crd_v1alpha1_quest_db_spec_stateful_set import IoQuestdbCrdV1alpha1QuestDBSpecStatefulSet  # noqa: E501
from kubernetes.client.rest import ApiException

class TestIoQuestdbCrdV1alpha1QuestDBSpecStatefulSet(unittest.TestCase):
    """IoQuestdbCrdV1alpha1QuestDBSpecStatefulSet unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test IoQuestdbCrdV1alpha1QuestDBSpecStatefulSet
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = kubernetes.client.models.io_questdb_crd_v1alpha1_quest_db_spec_stateful_set.IoQuestdbCrdV1alpha1QuestDBSpecStatefulSet()  # noqa: E501
        if include_optional :
            return IoQuestdbCrdV1alpha1QuestDBSpecStatefulSet(
                extra_volume_mounts = [
    ...
    def testIoQuestdbCrdV1alpha1QuestDBSpecStatefulSet(self):
        """Test IoQuestdbCrdV1alpha1QuestDBSpecStatefulSet"""
